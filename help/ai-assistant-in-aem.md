...
* **Welke toepassingen van Adobe steunt de Medewerker van AI in AEM?**\
  Op dit moment biedt AI Assistant ondersteuning voor productkennisonderzoeken in AEM as a Cloud Service, waaronder Sites, Assets, Dynamic Media, Cloud Manager en Forms.
* **wat zijn de mogelijkheden van AI Medewerker in AEM?**\
  AI Assistant in AEM is ontworpen om vragen te beantwoorden over Adobe Product Knowledge.
