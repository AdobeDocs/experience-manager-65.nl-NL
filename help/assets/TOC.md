...
+ [Toegankelijkheid [!DNL Assets]](accessibility.md)
...
+ Elementen beheren {#administer}
   ...
   + [[!DNL Assets] migratiehulplijn](assets-migration-guide.md)
...
+ Elementen beheren {#managing}
   ...
   + [Elementen inchecken en uitchecken](check-out-and-submit-assets.md)
