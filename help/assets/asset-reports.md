...
1. Configureer rapportdetails zoals titel, beschrijving, miniatuur en mappad in de CRX-opslagplaats waar het rapport wordt opgeslagen. Standaard is het mappad `/content/dam` . U kunt een ander pad opgeven.
   ...
   Het **[!UICONTROL Link Share]** -rapport geeft URL&#39;s weer naar elementen die vanuit [!DNL Assets] met externe gebruikers worden gedeeld. Het bevat e-mailadressen van de gebruiker die de middelen heeft gedeeld, e-mailadressen van gebruikers waarmee de elementen worden gedeeld, datum waarop de elementen worden gedeeld en vervaldatum voor de koppeling. De kolommen kunnen niet worden aangepast.
...
1. Als u een aangepaste kolom wilt weergeven, geeft u de naam van de kolom op onder **[!UICONTROL Custom Columns]** .
...
1. Voeg het eigenschapspad onder het knooppunt `jcr:content` in CRXDE toe met de padkiezer voor eigenschappen. U kunt ook het pad typen in het veld Pad eigenschap.
   ...
   ![&#x200B; kaart de bezitspad van wegen in jcr :content](assets/property_picker.png)
