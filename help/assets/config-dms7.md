...
>[!NOTE]
>
>Dynamische media - de Scene7-modus is alleen voor de AEM-auteur-instantie. Als dusdanig, moet u `runmode=dynamicmedia_scene7` op de instantie van de Auteur van AEM, *not* de instantie van de Publicatie van AEM vormen.
...
Met Feature Pack 18912 kunt u opgenomen elementen bulksgewijs via FTP importeren of elementen migreren van Dynamic Media - Hybride modus of Dynamic Media Classic naar Dynamic Media - Scene7-modus op AEM. Het is beschikbaar bij [Adobe Professional Services](https://www.adobe.com/experience-cloud/consulting-services.html).
...
**Voordat u Dynamic Media**  configureert - Nadat u uw instelgegevens via e-mail hebt ontvangen met dynamische media, moet u zich  [aanmelden ](https://www.adobe.com/marketing-cloud/experience-manager/scene7-login.html) bij Dynamic Media Classic om uw wachtwoord te wijzigen. Het wachtwoord dat in de e-mailprovisioning wordt ingevoerd, wordt door het systeem gegenereerd en is alleen bedoeld als tijdelijk wachtwoord. Het is belangrijk dat u het wachtwoord bijwerkt zodat Dynamic Media Cloud Service is ingesteld met de juiste referenties.

![dynamicmediaconfiguration2updated](assets/dynamicmediaconfiguration2updated.png)

**Om een Dynamische Configuratie van Media in Cloud Services te creëren**

1. Tik in AEM op het AEM logo om de globale navigatieconsole te openen en tik op het pictogram Gereedschappen en tik vervolgens op **[!UICONTROL Cloud Services > Dynamic Media Configuration.]**
...
1. Voer op de pagina **[!UICONTROL Create Dynamic Media Configuration]** een titel in, het e-mailadres van de Dynamic Media-account, het wachtwoord en selecteer vervolgens het gebied. Deze worden door Adobe in de provisioning-e-mail aan u verstrekt. Neem contact op met de ondersteuningsafdeling als u dit niet hebt ontvangen.
   ...
   >[!NOTE]
   >
   >Nadat u uw levering-e-mail met Dynamische geloofsbrieven van Media ontvangt, gelieve [login in ](https://www.adobe.com/marketing-cloud/experience-manager/scene7-login.html) Dynamische Klassiek van Media om uw wachtwoord te veranderen. Het wachtwoord dat in de e-mailprovisioning wordt ingevoerd, wordt door het systeem gegenereerd en is alleen bedoeld als tijdelijk wachtwoord. Het is belangrijk dat u het wachtwoord bijwerkt zodat de Dynamic Media Cloud Service wordt ingesteld met de juiste referenties.
...
Als u een geselecteerde map wilt markeren voor synchronisatie met Dynamic Media, selecteert u een elementmap en klikt u op **[!UICONTROL Properties.]** op het tabblad **[!UICONTROL Details]** in de vervolgkeuzelijst **[!UICONTROL Dynamic Media sync mode]** op de volgende drie opties. Wanneer u klaar bent, tikt u **[!UICONTROL Save.]** *Onthoud: Deze drie opties zijn niet beschikbaar als u **Alle inhoud synchroniseren**eerder hebt geselecteerd.* Zie ook  [Werken met Selectief publiceren op mapniveau in Dynamische media.](/help/assets/selective-publishing.md)
...
Als u uw configuratie verder wilt aanpassen, kunt u naar keuze om het even welke taken voltooien onder [ (Facultatief) het Vormen Geavanceerde Montages in Dynamische Media - Scene7 wijze](#optional-configuring-advanced-settings-in-dynamic-media-scene-mode).
...
Als u de configuratie en opstelling van Dynamische Media - de wijze van Scene7 verder wilt aanpassen, of zijn prestaties optimaliseren, kunt u één of meerdere van de volgende *facultatieve* taken voltooien:
...
Wanneer u in runmode `dynamicmedia_scene7` bent, gebruikt u het Dynamische Klassieke (Scene7) gebruikersinterface van Media om veranderingen in uw Dynamische montages van Media aan te brengen.
...
1. Klik AEM op het AEM om de globale navigatieconsole te openen en klik vervolgens op **[!UICONTROL Tools > General > CRXDE Lite.]**
...
1. Voer een van de volgende handelingen uit:
   ...
   * Als u een nieuwe naamgevingsconventie wilt definiëren terwijl u de voorinstelling instelt, vouwt u **[!UICONTROL Asset Naming Conventions]** uit en klikt u vervolgens in de vervolgkeuzelijst Bestandsnaamgeving op **[!UICONTROL Custom.]**
...
1. **[!UICONTROL Asset Naming Conventions]** uitvouwen en vervolgens in de vervolgkeuzelijst Bestandsnaamgeving op **[!UICONTROL Custom.]** klikken
...
1. Klik op **[!UICONTROL Active]** naast de naam van de nieuwe voorinstelling.
...
Als u een van deze parameters wilt bijwerken, volgt u de stappen in [Ondersteuning van MIME op type gebaseerde elementen/Dynamic Media Classic uploadtaakparameter](#enabling-mime-type-based-assets-scene-upload-job-parameter-support) inschakelen.
...
#### De dynamische Media Klassieke uploadverbinding {#updating-the-scene-upload-connection} bijwerken
...
1. Tik AEM op het AEM om de globale navigatieconsole te openen en tik op **[!UICONTROL Tools > General > CRXDE Lite.]**
