...
description: Leer hoe u Dynamic Media kunt gebruiken om bedrijfsmiddelen te leveren voor gebruik op internet, mobiele apparaten en sociale sites.
...
>[!NOTE]
>
>Om de verschillen te begrijpen tussen het gebruiken van Dynamic Media en het integreren van Dynamic Media Klassiek met AEM, zie [Dynamic Media Klassieke integratie versus Dynamic Media](/help/sites-administering/scene7.md#aem-scene-integration-versus-dynamic-media).
...
Wanneer u op een afbeeldingselement klikt, is de weergave van het element anders en zijn Dynamic Media [ingeschakeld](config-dynamic.md#enabling-dynamic-media). Dynamic Media gebruiken de HTML5-viewers op aanvraag.
