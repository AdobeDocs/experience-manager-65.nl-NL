...
Op de achtergrond gebruikt de Smart Content Service het Adobe AI-framework om het herkenningsalgoritme voor images op te leiden op de tagstructuur en de zakelijke taxonomie. Deze inhoudsinfo wordt vervolgens gebruikt om relevante tags toe te passen op een andere set elementen.
