...
Zie ook [&#x200B; Optimalisering van het Beeld met Formaten van het Beeld van Next-gen (WebP en AVIF) &#x200B;](https://medium.com/adobetech/image-optimization-with-next-gen-image-formats-webp-and-avif-248c75afacc4)
...
>`https://smartimaging.scene7.com/is/image/SmartImaging/sample1?cache=update`>Als u de gehele cache wilt ongeldig maken, moet u een ondersteuningscase maken.
