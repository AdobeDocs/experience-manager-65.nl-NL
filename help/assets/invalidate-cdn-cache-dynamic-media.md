...
1. Op de **[!UICONTROL CDN Invalidation - Confirm]** pagina, in de **[!UICONTROL URLs]** in de keuzelijst kunt u een lijst zien met een of meer URL&#39;s die zijn gegenereerd op basis van de CDN-validatiesjabloon die u eerder hebt gemaakt en de elementen die u zojuist hebt toegevoegd.
   ...
   Als u bijvoorbeeld het voorbeeld voor de CDN-validatiesjabloon gebruikt dat eerder in de stappen werd weergegeven, kunt u een enkel element met de naam `spinset`. Wanneer u navigeert naar **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL CDN Invalidation]** resulteert dit in de volgende vijf gegenereerde URL&#39;s in het dialoogvenster **[!UICONTROL CDN Invalidation - Confirm]** gebruikersinterface:
...
1. Selecteer in de rechterbovenhoek van de pagina de optie **[!UICONTROL Submit]** om het CDN-validatieproces te starten.
