...
# Het ongeldig maken van het CDN geheime voorgeheugen door middel van Dynamische Media {#invalidating-cdn-cache-for-dm-assets}
...
1. Op de **[!UICONTROL CDN Invalidation - Confirm]** pagina, in **[!UICONTROL URLs]** lijstvakje, zult u een lijst van één of meerdere URLs zien die van het Malplaatje van de Bevestiging CDN wordt geproduceerd u vroeger en de activa u enkel toevoegde.
