...
* [!DNL Adobe I/O] Console - integratie wordt gecreeerd voor de Lancering van Adobe.
...
Zie [AEM integreren met Adobe starten via [!DNL Adobe I/O]](https://helpx.adobe.com/experience-manager/using/aem_launch_adobeio_integration.html) voor meer informatie over het instellen van Adobe starten van cloudconfiguratie.
