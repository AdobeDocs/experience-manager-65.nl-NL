...
1. Tik op de stap Afbeeldingselementen **[!UICONTROL van dynamisch mediaproces en tik op het tabblad]** Miniaturen **** of klik op deze knop. Wijzig desgewenst de grootte van de miniaturen en tik op **[!UICONTROL OK]**.
