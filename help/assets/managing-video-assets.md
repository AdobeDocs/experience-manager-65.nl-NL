...
1. Klik op de werkbalk op **[!UICONTROL Overlay Node]** . Of selecteer **[!UICONTROL Overlay Node]** in het contextmenu.
...
1. Klik in de werkbalk op **[!UICONTROL Save All]** .
...
1. In het [!UICONTROL Step Properties] dialoogvakje, onder het **[!UICONTROL Common]** lusje, breid **Geavanceerde Montages** uit.
...
1. Klik op de Google Cloud-pagina in de rechterbovenhoek op **[!UICONTROL Console]** .
...
1. Ga als volgt te werk op de pagina **[!UICONTROL Add credentials to your project]** , stap 1:
   ...
   * Selecteer **[!UICONTROL YouTube Data API v3]** in de vervolgkeuzelijst **[!UICONTROL Which API are you using?]** .
   ...
   * Selecteer **[!UICONTROL User data]** in de vervolgkeuzelijst **[!UICONTROL What data are you accessing?]** .
...
1. Voer op de pagina YouTube-configuratie maken onder Instellingen Google Cloud-platform in het veld **[!UICONTROL Application Name]** de Google-project-id in.
...
1. Voer in het veld Titel van het dialoogvenster YouTube Channel-instellingen de naam in van het kanaal dat u in de taak **[!UICONTROL Adding one or more channels to YouTube]** eerder hebt gemaakt.
...
Als u het verwerkingsprofiel voor metagegevens wilt maken, kopieert u eerst waarden uit de velden **[!UICONTROL Field Label]** , **[!UICONTROL Map to property]** en **[!UICONTROL Choices]** . Deze bevinden zich allemaal in Metagegevensschema&#39;s voor video. Vervolgens kunt u het verwerkingsprofiel voor YouTube-videometagegevens samenstellen door deze waarden eraan toe te voegen.
...
1. Klik onder de kop YouTube Publishing op **[!UICONTROL YouTube Category]** .
...
1. Voer in het tekstveld **[!UICONTROL Profile title]** in het dialoogvenster Metagegevensprofiel toevoegen de naam `YouTube Video` in en klik op **[!UICONTROL Create]** .
...
1. Pas het metagegevensprofiel voor YouTube Publishing toe op de mappen waarin u video&#39;s gaat uploaden. U moet zowel het profiel Metagegevens als het videoprofiel hebben ingesteld.
   ...
   Zie [&#x200B; Profielen van Meta-gegevens &#x200B;](/help/assets/metadata-config.md#metadata-profiles) en [&#x200B; Videoprofielen &#x200B;](/help/assets/video-profiles.md).
...
1. De voortgang van de elementen weergeven. Wanneer u op een element klikt, opent u het vervolgkeuzemenu en selecteert u **[!UICONTROL Timeline]** . Selecteer **[!UICONTROL Workflows]** als u het wilt beperken tot workflowactiviteiten zoals coderen of YouTube publiceren.
   ...
   >[!NOTE]
   >
   >Het kan lange tijd voor mislukking/foutenmeldingen om definitief worden geregistreerd wegens veelvoudige werkschemeconfiguraties op **[!UICONTROL retries]**, **[!UICONTROL retry delay]**, en **[!UICONTROL timeout]** van [&#x200B; https://localhost :4502/system/console/configMgr &#x200B;](https://localhost:4502/system/console/configMgr), bijvoorbeeld vergen:
   >
...
1. Voor mislukte taken raadpleegt u de beschikbare workflowfouten via **[!UICONTROL Tools]** > **[!UICONTROL Workflow]** > **[!UICONTROL Failures]** . In **[!UICONTROL Workflow Failure]** worden alle mislukte workflowactiviteiten vermeld.
...
1. Zie Workflowarchief beschikbaar op **[!UICONTROL Tools]** > **[!UICONTROL Workflow]** > **[!UICONTROL Archive]** voor voltooide workflows. In **[!UICONTROL Workflow Archive]** worden alle voltooide workflowactiviteiten weergegeven.
...
1. Zoek aan een specifiek punt in de video, specificeer de tijd in seconden op het **tekst** gebied en klik **Jump**. Als u bijvoorbeeld de eerste 20 seconden van de video wilt overslaan, voert u 20 in het tekstveld in.
