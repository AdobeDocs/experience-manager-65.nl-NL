...
1. Selecteer **[!UICONTROL Append mode]** als u de nieuwe metagegevens wilt toevoegen aan de bestaande metagegevens in velden die meerdere waarden bevatten. Als u deze optie niet selecteert, worden de bestaande metagegevens in de velden vervangen door de nieuwe metagegevens. Klik op **[!UICONTROL Submit]** .

![ het schemaschemabulk is van toepassing op veelvoudige activa ](assets/metadata-schema-bulk-edit.gif)

>[!CAUTION]
>
>Voor velden met één waarde worden de nieuwe metagegevens niet toegevoegd aan de bestaande waarde in het veld, zelfs niet als u **[!UICONTROL Append mode]** selecteert.
...
1. Klik op **[!UICONTROL Select File]** op de pagina **[!UICONTROL Metadata Import]** . Selecteer het CSV-bestand met de metagegevens.
...
1. Selecteer de elementenmap die elementen bevat waarvoor u metagegevens wilt exporteren. Selecteer in de werkbalk de optie **[!UICONTROL Export metadata]** .
...
1. Open het bericht in het Postvak IN voor de exporttaak. Selecteer de baan en klik **[!UICONTROL Open]** van de toolbar. Klik op **[!UICONTROL CSV Download]** op de werkbalk om het CSV-bestand met de metagegevens te downloaden. Klik op **[!UICONTROL Close]** .
...
U kunt een metagegevensprofiel toepassen op een map vanuit het menu **[!UICONTROL Tools]** of vanuit **[!UICONTROL Properties]** als u zich in de map bevindt. In deze sectie wordt beschreven hoe u op beide manieren metagegevensprofielen kunt toepassen op mappen.
...
1. Klik in de map op het vinkje om het te selecteren en klik vervolgens op **[!UICONTROL Properties]** .
1. Selecteer de tab **[!UICONTROL Metadata Profiles]** , selecteer **[!UICONTROL None]** in de vervolgkeuzelijst en klik op **[!UICONTROL Save]** . Mappen waaraan al een profiel is toegewezen, worden aangegeven door de naam van het profiel direct onder de mapnaam weer te geven.
