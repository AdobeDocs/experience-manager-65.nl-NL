...
1. Klik op **[!UICONTROL Live Copy Source]** . Klik op **[!UICONTROL Live Copy Overview]** om de console te openen. Dit dashboard biedt een status op hoofdniveau van alle onderliggende elementen.
...
1. Selecteer een element en klik op **[!UICONTROL Relationship Status]** in de werkbalk om de gedetailleerde informatie over elk element in de map voor live kopieën weer te geven.
...
Selecteer een actief exemplaar of een map, open het linkerspoor en klik op **[!UICONTROL References]** . U kunt ook een element of map selecteren en de sneltoets `Alt + 4` gebruiken.

![&#x200B; Acties beschikbaar in het spoor van Verwijzingen voor het geselecteerde levende exemplaar &#x200B;](assets/referencerail_livecopy.png)
...
Als u een synchronisatiehandeling wilt starten, opent u **[!UICONTROL Properties]** pagina van een live kopie, klikt u op **[!UICONTROL Live Copy]** en klikt u op de gewenste actie op de werkbalk.

Om de statussen en de informatie te zien met betrekking tot een synchroniseren actie, zie [&#x200B; Informatie en status van een levende exemplaar &#x200B;](#statuslcasset) en [&#x200B; Informatie en statussen van alle levende exemplaren van een omslag &#x200B;](#status-lc-folder).
...
Als u een live kopie wilt onderbreken of hervatten, opent u **[!UICONTROL Properties]** pagina&#39;s van een live kopie, klikt u op **[!UICONTROL Live Copy]** en klikt u op de gewenste actie op de werkbalk.

U kunt ook snel relaties van meerdere elementen in een live kopieermap vanaf de **[!UICONTROL Live Copy Overview]** -console onderbreken of hervatten. Zie [&#x200B; acties op vele activa in levende exemplaaromslagen &#x200B;](#bulk-actions) nemen.
...
U kunt ook snel meerdere elementen in een live kopieermap loskoppelen van de **[!UICONTROL Live Copy Overview]** -console. Zie [&#x200B; acties op vele activa in levende exemplaaromslagen &#x200B;](#bulk-actions) nemen.
...
1. Selecteer in dit dashboard een live-kopie van een map met livekopieën. Klik op de gewenste handelingen op de werkbalk. De beschikbare acties zijn **[!UICONTROL Synchronize]** , **[!UICONTROL Reset]** , **[!UICONTROL Suspend]** en **[!UICONTROL Detach]** . U kunt deze handelingen snel uitvoeren op elk element in een willekeurig aantal mappen met live kopieën dat een live relatie heeft met de geselecteerde bronmap.
