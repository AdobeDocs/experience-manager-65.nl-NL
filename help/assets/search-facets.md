...
1. Geef in het veld [!UICONTROL Property Name] een geldige naam op voor de eigenschap metadata die u aan de voorspelling wilt koppelen. Dit is de naam op basis waarvan de zoekopdracht wordt uitgevoerd. Voer bijvoorbeeld `jcr:content/metadata/dc:description` of `./jcr:content/metadata/dc:description` in.
...
Als u bijvoorbeeld &quot;Afbeeldingen&quot; selecteert voor bestandstypen, wordt de zoekquery voor de elementen samengesteld door de eigenschap `value` te combineren met een OR-bewerking. Bijvoorbeeld, wordt de onderzoeksvraag naar beelden gebouwd door de resultaten te combineren die voor *worden aangepast beeld/jpeg*, *beeld/gif*, *beeld/png*, *beeld/pjpeg*, en *beeld/tiff* voor het bezit `jcr:content/metadata/dc:format` gebruikend een OF verrichting.
...
1. Controleer of **[!UICONTROL Single Select]** is gewist, zodat de gebruiker meerdere opties voor bestandstypen tegelijk kan selecteren (bijvoorbeeld Afbeeldingen, Documenten, Multimedia en Archieven). Als u **[!UICONTROL Single Select]** selecteert, kan de gebruiker slechts één optie selecteren voor bestandstypen tegelijk.
...
1. Navigeer naar het deelvenster Filters in de gebruikersinterface van [!DNL Assets] . De voorspelling **[!UICONTROL Multi Value Property]** wordt toegevoegd aan het deelvenster.
...
1. Selecteer **[!UICONTROL Show match all tags option]** om te zoeken naar elementen die alle tags bevatten die u opgeeft.
...
| Naam voorspelling | Beschrijving | Properties |
|---|---|---|
| [!UICONTROL Fulltext] | Zoekvoorspelling om volledige tekstzoekopdrachten uit te voeren op een volledig elementknooppunt. Het wordt in kaart gebracht met jcr :contains exploitant. U kunt een relatief pad opgeven als u een volledige tekstzoekopdracht wilt uitvoeren op een bepaald gedeelte van het knooppunt met elementen. | <ul><li>Label</li><li>Plaatsaanduiding</li><li>Eigenschapnaam</li><li>Beschrijving</li></ul> |
...
>* [&#x200B; activa van het Onderzoek &#x200B;](search-assets.md)
