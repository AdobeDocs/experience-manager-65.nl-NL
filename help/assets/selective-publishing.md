...
1. Selecteer een van de volgende opties in het menu **[!UICONTROL Quick Publish]** menulijst.
...
1. Vouw in het linkerdeelvenster uit **[!UICONTROL Status]** Vouw vervolgens de **[!UICONTROL Dynamic Media]** zoekvoorspelling.
