...
1. [Koppel URL&#39;s aan uw webtoepassing](/help/assets/linking-urls-to-yourwebapplication.md) of [sluit de video- of afbeeldingsviewer](/help/assets/embed-code.md)in.
   ...
   Zie Een centrifugeerset [koppelen aan een webpagina](/help/assets/linking-urls-to-yourwebapplication.md) en de video- of afbeeldingsviewer [](/help/assets/embed-code.md)insluiten.
...
U kunt afbeeldingen voor de centrifuges uploaden zoals u elk ander element in AEM-elementen [](/help/assets/managing-assets-touch-ui.md)uploadt.
...
>U kunt ook automatisch spin-sets maken via voorinstellingen voor [batchsets](/help/assets/config-dms7.md#creating%20batch%20set%20presets%20to%20auto-generate%20image%20sets%20and%20spin%20sets). **** Belangrijk: De reeksen van de partij worden gecreeerd door IPS (het Systeem van de Productie van het Beeld) als deel van activa opnemen en zijn beschikbaar slechts op Dynamische Media - wijze Scene7.
>
>Zie &quot;het Creëren van partijreeks vooraf instelt om de Reeksen van het Beeld en Reeksen van de Draai&quot;in het [Vormen Dynamische Media - wijze](/help/assets/config-dms7.md#creating%20batch%20set%20presets%20to%20auto-generate%20image%20sets%20and%20spin%20sets)Scene7 automatisch te produceren.
