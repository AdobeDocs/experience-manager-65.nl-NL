...
1. Selecteer in de [!DNL Assets] gebruikersinterface de map waarop u vertaalservices wilt toepassen.
1. Klik in de werkbalk **[!UICONTROL Properties]** om de **[!UICONTROL Folder Properties]** pagina weer te geven.
