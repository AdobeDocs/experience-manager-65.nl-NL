...
1. Selecteer het pictogram **[!UICONTROL Product Selector]** (vergrootglas) en navigeer naar een product in de catalogus.
   ...
   Selecteer **[!UICONTROL Sort]** door om te veranderen of de Experience Manager door nieuwste in oudste of oudste aan nieuwste sorteert.
...
1. Selecteer het **[!UICONTROL Site Selector]**-pictogram (map met vergrootglas) en navigeer naar een pagina in uw Experience Manager Sites waarnaar u de hotspot of afbeelding met hyperlinks wilt koppelen.
...
1. Als u in de modus **[!UICONTROL Preview]** de hotspot of afbeelding met hyperlinks selecteert, navigeert u naar de door u opgegeven Experience Manager-sitepagina.
