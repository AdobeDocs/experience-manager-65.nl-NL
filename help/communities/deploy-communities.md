...
1. stap 3 en 4 op alle auteur en publiceer instanties herhalen

Meer informatie over het installeren van bundels vindt u op de pagina [Webconsole](/help/sites-deploying/configuring-web-console.md#bundles) .
...
Wanneer de gekozen implementatie een [publicatiefarm](/help/communities/topologies.md#tarmk-publish-farm)is, moet één AEM-publicatieexemplaar worden geïdentificeerd als de instantie **`primary publisher`** voor activiteiten die niet in alle gevallen moeten plaatsvinden, zoals functies die afhankelijk zijn van **meldingen **of **Adobe Analytics**.
...
* toegang tot de console van de Replicatie op auteur
   ...
   * van globale navigatie: **Hulpmiddelen, Plaatsing, Replicatie, Medewerkers op auteur**
