...
Het framework gebruikt `Twitter Bootstrap` om een responsief, flexibel ontwerp naar de site te brengen. Een van de vele vooraf geladen Bootstrap-thema&#39;s kan worden geselecteerd om de geselecteerde communitygroepsjabloon op te maken, anders kan een Bootstrap-thema worden geüpload.
...
Het [&#x200B; deelvenster MINIATUUR &#x200B;](#thumbnail) staat toe dat een afbeelding wordt geüpload om de communautaire groep te vertegenwoordigen voor sitebezoekers in de publicatieomgeving en in de console Groepen van de Plaats van Gemeenschappen in de auteursomgeving.
