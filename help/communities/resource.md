...
* Selecteer de communitysite waaraan de activeringsbronnen worden toegevoegd:
   * Selecteer **[!UICONTROL Enablement Tutorial]**.
* Selecteer **[!UICONTROL Create]** in het menu.
...
* **[!UICONTROL Site Name]**
   ...
   Instellen op de naam van de geselecteerde communitysite: Zelfstudie inschakelen
...
* **[!UICONTROL Description]**
   ...
   Sneeuw voor beginners.

* **[!UICONTROL Add Image]**

   Voeg een beeld toe om het Middel aan het lid in hun mening van Toewijzingen te vertegenwoordigen.

   ![basis-info](assets/basic-info.png)
...
![uploaden, video](assets/upload-video.png)
...
* **[!UICONTROL Add Assignees]**
   ...
   ![add-toewijzingen](assets/add-assignments.png)
...
*Tip: Vernieuw de pagina als beide bronnen niet zichtbaar zijn.*

![bron vernieuwen](assets/refresh-resource.png)
...
* **[!UICONTROL Show in Catalog]**
   ...
   Niet ingeschakeld laten

* **[!UICONTROL Upload an image]**

   Om de het leren weg in de console van Middelen te vertegenwoordigen.

   ![leerpad-basis](assets/learningpath-basic.png)
...
* Selecteer **[!UICONTROL Submit]**.
   ...
   ![leerpad](assets/learningpath-add.png)

   ![aanmaakpad](assets/create-learningpath.png)

* Selecteer **[!UICONTROL Next]**

   ![leerpad-instellingen](assets/learningpath-settings.png)
