...
# AEM 6.5 - Gebruikershandleiding voor formulieren {#forms}

+ [Gebruikershandleiding voor AEM 6.5-formulieren](home.md)
+ Opmerkingen bij de release {#release-notes-new-features}
   + [Opmerkingen bij de release](https://docs.adobe.com/content/help/en/experience-manager-65/release-notes/release-notes.html#experience-manager-forms)
...
+ Aan de slag {#getting-started}
   + [Inleiding tot AEM-formulieren](using/introduction-aem-forms.md)
   ...
   + [Inleiding tot de service Automated Forms Conversion](https://docs.adobe.com/content/help/en/aem-forms-automated-conversion-service/table-of-contents/introduction.html)
...
+ AEM-formulieren installeren en configureren {#install-aem-forms}
   ...
   + [Een persistentietype kiezen voor een installatie van AEM Forms](using/choosing-persistence-type-for-aem-forms.md)
   + AEM-formulieren installeren op OSGi {#osgi-installation}
      ...
      + [Forms-centric workflow op OSGi installeren en configureren](using/installing-configuring-forms-centric-workflow-on-osgi.md)
      ...
      + [De service Automated Forms Conversion installeren en configureren](https://docs.adobe.com/content/help/en/aem-forms-automated-conversion-service/table-of-contents/configure-service.html)
   + AEM-formulieren installeren op JEE {#jee-installation}
      ...
      + [AEM-formulieren installeren en implementeren in JEE met JBoss-sleutel](http://www.adobe.com/go/learn_aemforms_installTurnkey_65)
      ...
      + [Installatie van één server voor AEM Forms voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_65)
      + [AEM-formulieren installeren en implementeren in JEE voor JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_65)
      ...
      + [Installatie van AEM Forms Server-cluster voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_65)
      + [AEM-formulieren op JEE configureren in JBoss-cluster](http://www.adobe.com/go/learn_aemforms_clusterJBoss_65)
      + [AEM-formulieren configureren op JEE in WebSphere-cluster](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_65)
   + AEM-formulieren configureren {#configure-aem-forms}
      ...
      + [AEM-formulieren verbinden met Adobe LiveCycle](using/aem-livecycle-connector.md)
      + [AEM-formulieren configureren voor het verzenden van formuliergegevens naar AEM Forms on JEE-processen](using/submit-form-data-livecycle-process.md)
      + [AEM-bureaubladtoepassing voor AEM-formulieren](/help/forms/using/aem-desktop-app-for-aem-forms.md)
+ AEM-formulieren upgraden {#upgrade-aem-forms}
   + [Beschikbare upgradepaden](using/upgrade.md)
   + AEM-formulieren bijwerken op OSGi {#aem-forms-osgi-upgrade}
   ...
   + AEM-formulieren upgraden naar JEE {#aem-forms-jee-upgrade}
      + [Upgrade van AEM-formulieren voorbereiden](http://www.adobe.com/go/learn_aemforms_prepareupgrade_65)
      ...
      + [Een upgrade uitvoeren van een AEM Forms-versie naar AEM 6.5 Forms in JEE voor JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
      + [Een upgrade uitvoeren van een AEM Forms-versie naar AEM 6.5 Forms in JEE voor JBoss turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [Een upgrade uitvoeren van een AEM Forms-versie naar AEM 6.5 Forms op JEE for WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
+ AEM-formulieren beheren {#manage-administer-aem-forms}
   + [AEM-formulieren op OSGi-groepen en -rechten](using/forms-groups-privileges-tasks.md)
   ...
   + [XDP- en PDF-documenten ophalen in AEM-formulieren](using/get-xdp-pdf-documents-aem.md)
   + [Elementen importeren en exporteren naar AEM-formulieren](using/import-export-forms-templates.md)
   ...
   + Gebruikersgegevens verwerken {#handling-user-data}
      + [Forms-centric workflows op OSGi](using/forms-workflow-osgi-handling-user-data.md)
      + [Gebruikersbeheer voor formulieren](using/user-management-handling-user-data.md)
   ...
   + Verhardende AEM Forms Environment {#hardening-aem-forms-environment}
      + [AEM-formulieren verharden en beveiligen op OSGi-omgeving](using/hardening-securing-aem-forms-environment.md)
      + [Algemene beveiligingsoverwegingen voor AEM Forms on JEE](using/general-security-considerations.md)
      + [AEM-formulieren op JEE-omgevingen verharden](using/hardening-aem-forms-jee-environment.md)
      + [Beveiligde beheerinstellingen configureren voor AEM-formulieren op JEE](using/configuring-secure-administration-settings-aem.md)
...
+ Adaptieve formulieren - Basisontwerp {#adaptive-forms-basic-authoring}
   ...
   + [Plaatsaanduidingstekst in AEM-formulieren](using/placeholder-text-in-aem-forms-.md)
...
+ Adaptieve formulieren - Geavanceerde ontwerpen {#adaptive-forms-advanced-authoring}
   ...
   + [Adobe Sign in een adaptief formulier gebruiken](using/working-with-adobe-sign.md)
   ...
   + [De AEM-vertaalworkflow gebruiken om adaptieve formulieren en recorddocumenten te lokaliseren](using/using-aem-translation-workflow-to-localize-adaptive-forms.md)
   ...
   + [Aangepaste formulieren synchroniseren met XFA-formuliersjablonen](using/synchronizing-adaptive-forms-xfa.md)
   + [Adobe-ondertekening integreren met AEM-formulieren](using/adobe-sign-integration-adaptive-forms.md)
   + [Revisies voor elementen in formulieren maken en beheren](using/create-reviews-forms.md)
   + [Een adaptief formulier of interactieve communicatie insluiten in de toepassing Eén pagina voor AEM-sites](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
   + [Standaard foutberichten voor validatie adaptieve formulieren](/help/forms/using/standard-validation-error-messages-adaptive-forms.md)
...
+ Workflows {#workflows}
   ...
   + [Een gebruiker of groep dynamisch selecteren voor workflowstappen die zijn gebaseerd op AEM Forms](using/dynamically-select-a-user-or-group-for-aem-workflow.md)
...
+ AEM-werkruimte voor formulieren {#use-aem-forms-workspace}
   + [Inleiding tot de werkruimte van AEM-formulieren](using/introduction-html-workspace.md)
   + [Werken met de werkruimte van AEM-formulieren](using/html-workspace-overview.md)
   + [AEM Forms Workspace Architecture](using/html-workspace-architecture.md)
   + [Functies van de werkruimte van AEM-formulieren zijn niet beschikbaar in de Flex-werkruimte](using/features-html-workspace-available-flex.md)
   + [Functies van de Flex-werkruimte zijn niet beschikbaar in de werkruimte van AEM-formulieren](using/features-flex-workspace-available-html.md)
   ...
   + [Toepassingen van derden integreren in de werkruimte van AEM Forms](using/integrating-correspondence-management-html-workspace.md)
   + [Beschrijving van JSON-object in AEM Forms-werkruimte](using/html-workspace-json-object-description.md)
   + [Inleiding tot de werkruimte van AEM-formulieren aanpassen](using/introduction-customizing-html-workspace.md)
   + [Algemene stappen voor aanpassing van de AEM-werkruimte](using/generic-steps-html-workspace-customization.md)
   ...
   + [Werken met indelingen in de werkruimte van AEM-formulieren](using/form-sets-html-workspace.md)
   + [API&#39;s die worden gebruikt in de werkruimte van AEM-formulieren](using/apis-used-html-workspace.md)
   + [Een nieuw proces starten met bestaande procesgegevens in de werkruimte van AEM Forms](using/initiating-new-process-existing-process.md)
   + [Twee AEM Forms-werkruimteinstanties hosten op één server](using/two-html-workspace-instances-one.md)
   ...
   + [Aan de slag met de werkruimte van AEM-formulieren](using/getting-started-livecycle-html-workspace.md)
   ...
   + [AEM-formulierwerkruimte integreren met Microsoft Office SharePoint Server](using/integrating-aem-forms-workspace-with-microsoft-office-sharepoint-server.md)
   + [Werken met to-do-lijsten](using/todo-lists.md)
   + [Richtlijnen voor het oplossen van problemen in de werkruimte van AEM Forms](using/troubleshooting-guidelines-html-workspace.md)
+ AEM Forms-app {#aem-forms-app}
   + [Inleiding tot AEM Forms-app](using/aem-forms-app.md)
   + [Omgeving instellen voor de app AEM Forms](using/setup-environment-mobile-workspace.md)
   + [Het Xcode-project instellen en de iOS-app ontwikkelen](using/setup-xcode-project-build-installer.md)
   + [Een veilige app voor AEM-formulieren voor iOS maken](using/building-secure-mobile-workspace-app.md)
   ...
   + [De Android-app voor AEM Forms ontwikkelen](using/setup-eclipse-project-build-installer.md)
   ...
   + [Aanmelden bij de app AEM Forms](using/log-mobile-workspace.md)
   ...
   + [Problemen met de app AEM Forms oplossen](using/issues-aem-forms-app.md)
+ HTML5-formulieren {#html5-forms}
   ...
   + [Verschil tussen functies in HTML5-formulieren en PDF-formulieren](using/feature-differentiation-html5-forms-pdf-forms.md)
   ...
   + [Formulierset in AEM-formulieren](using/formset-in-aem-forms.md)
...
+ AEM-formulieren integreren met Experience Cloud-oplossingen {#integrate-aem-forms-with-experience-cloud-solutions}
   + [Gerichte ervaringen maken in AEM-formulieren](/help/forms/using/experience-targeting-forms.md)
   ...
   + [Analyserapporten van AEM Forms weergeven en begrijpen](using/view-understand-aem-forms-analytics-reports.md)
...
+ AEM-formulieren publiceren en verwerken {#publish-process-aem-forms}
   ...
   + [Forms-toepassingen en -taken beheren in AEM Inbox](using/manage-applications-inbox.md)
   + [Gecontroleerde map in AEM-formulieren](using/watched-folder-in-aem-forms.md)
...
+ Documentbeveiliging {#use-document-security}
   ...
   + [Reader-PDF-documenten die met een beleid zijn beveiligd, uitbreiden met de Portable Protection-bibliotheek](using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
   ...
   + [Een document namens een andere gebruiker beveiligen](using/protect-document-on-behalf-of-another-user.md)
...
+ Beheerdershulp voor AEM-formulieren in JEE {#administrator-help}
   ...
   + Gebruikersbeheer configureren {#configure-user-management}
      ...
      + [AEM-formulieren configureren om domeininformatie vooraf in te stellen](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
   ...
   + Acrobat Reader DC-extensies configureren {#configure-acrobat-reader-dc-extensions}
      ...
      + [Onlineopmerkingen inschakelen voor de plug-in voor de webbrowser van Adobe Reader](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
   ...
   + Formulieren configureren {#configure-forms}
      ...
      + [Caching voor Forms configureren](/help/forms/using/admin-help/configuring-caching-forms.md)
      ...
      + [Locaties voor Forms configureren](/help/forms/using/admin-help/configuring-locations-forms.md)
   ...
   + AEM-formulieren Back-up en herstel {#aem-forms-backup-recovery}
      ...
      + [Back-up maken van de AEM-formuliergegevens](/help/forms/using/admin-help/backing-aem-forms-data.md)
...
+ Referentie ontwikkelaar {#developer-reference}
   ...
   + [AEM-formulieren in Java API-naslaggids voor JEE](https://helpx.adobe.com/experience-manager/6-5/forms/programlc/javadoc/index.html)
   ...
   + Programmeren met AEM-formulieren op JEE {#programming-aem-forms-jee}
      + Inleiding tot programmeren met AEM Forms on JEE {#introduction-programming-aem-forms-jee}
         + [Introductie van Java API QuickStart](developing/introducing-java-api-soap-quick.md)
         + [AEM-formulieren aanroepen met API&#39;s](developing/invoking-aem-forms-using-apis.md)
         + [AEM-formulierprocessen begrijpen](developing/aem-forms-processes.md)
      ...
      + Java API Snel starten - Codevoorbeelden {#java-api-quick-start-code-examples}
         ...
         + [Acrobat Reader DC-extensies ServiceJava API Quick Start (SOAP)](developing/acrobat-reader-dc-extensions-service.md)
         + [Back-up- en herstelservice APIQuick start](developing/backup-restore-service-api-quick.md)
         + [Java APIQuick Start (SOAP) Barcoded Forms Service](developing/barcoded-forms-service-java-api.md)
         ...
         + [Java API QuickStart (SOAP) voor Distiller-service](developing/distiller-service-java-api-quick.md)
         ...
         + [Forms Service API, snel aan de slag](developing/forms-service-api-quick-starts.md)
         ...
         + [Java APIQuick Start (SOAP) van XMP-hulpprogramma&#39;s](developing/xmp-utilities-service-java-api.md)
      + AEM-formulieren aanroepen op JEE met behulp van API&#39;s {#invoking-aem-forms-jee-apis}
         + [AEM-formulieren aanroepen met behulp van REST-verzoeken](developing/invoking-aem-forms-using-rest.md)
         + [AEM-formulieren aanroepen met webservices](developing/invoking-aem-forms-using-web.md)
         + [AEM-formulieren aanroepen met behulp van Remoting](developing/invoking-aem-forms-using-remoting.md)
         + [AEM-formulieren aanroepen met webservices](developing/invoking-human-centric-long-lived.md)
         + [AEM-formulieren aanroepen met de JavaAPI](developing/invoking-aem-forms-using-java.md)
         + [Flash Builder-toepassingen maken die SSO-verificatie uitvoeren met behulp van HTTP-tokens](developing/creating-flash-builder-applications-perform.md)
      + Servicebewerkingen uitvoeren met behulp van API&#39;s {#performing-service-operations-using-apis}
         ...
         + [Webtoepassingen maken die formulieren renderen](developing/creating-web-applications-renders-forms.md)
         ...
         + [Ingediende formulieren verwerken](developing/handling-submitted-forms.md)
         ...
         + [Formulieren vooraf invullen met stroombare indelingen](developing/prepopulating-forms-flowable-layouts.md)
         + [Formulieren weergeven op basis van fragmenten](developing/rendering-forms-based-fragments.md)
         + [Formulieren renderen op waarde](developing/rendering-forms-value.md)
         + [Formulieren weergeven als HTML](developing/rendering-forms-html.md)
         + [Formulieren weergeven op de client](developing/rendering-forms-client.md)
         + [HTML-formulieren renderen met aangepaste CSS-bestanden](developing/rendering-html-forms-using-custom.md)
         + [HTML-formulieren renderen met CustomToolbars](developing/rendering-html-forms-custom-toolbars.md)
         + [Interactieve PDF-formulieren renderen](developing/rendering-interactive-pdf-forms.md)
         + [Formulieren weergeven waarvoor rechten zijn ingeschakeld](developing/rendering-rights-enabled-forms.md)
