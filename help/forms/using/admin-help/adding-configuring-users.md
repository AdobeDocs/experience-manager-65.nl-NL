...
1. Onder **[!UICONTROL General Settings]**, geeft u de gewenste gegevens op en klikt u vervolgens op **[!UICONTROL Next]**. Zie voor meer informatie over de instellingen [Gebruikersinstellingen](adding-configuring-users.md#user-settings).
1. (Optioneel) Als u de gebruiker aan een groep wilt toevoegen, klikt u op **[!UICONTROL Find Groups]** en voert u de volgende taken uit:
   ...
   * In de **[!UICONTROL Find]** typt u de groepsnaam geheel of gedeeltelijk.
...
1. (Optioneel) Als u rollen wilt toewijzen aan de gebruiker, klikt u op **[!UICONTROL Find Roles]** selecteert u het selectievakje voor de rollen die u wilt toewijzen en klikt u vervolgens op **[!UICONTROL OK]**.
1. Klik op **[!UICONTROL Finish]**.

   >[!NOTE]
   >
   >Als er een aanmeldingsprobleem optreedt met de gebruiker, raadpleegt u [AEM Forms on JEE-gebruiker kan zich niet aanmelden bij AEM Forms aan OSGi-zijde](https://helpx.adobe.com/aem-forms/kb/AEM-users-fails-to-login.html).
...
1. Typ en bevestig het nieuwe wachtwoord en klik vervolgens op **[!UICONTROL OK]**. Het wachtwoord moet minimaal acht tekens lang zijn.
...
1. Voer de volgende taken uit om te zoeken naar de gebruiker die u wilt bewerken:
   ...
   * In de **[!UICONTROL Find]** typt u de zoekcriteria.
   * In de **[!UICONTROL Using]** list, selecteer **[!UICONTROL Name]**, **[!UICONTROL Email]**, of **[!UICONTROL User ID]**.
   * In de **[!UICONTROL In list]**, selecteert u **[!UICONTROL Users]**.
...
1. Voor een gebruiker die deel uitmaakt van een lokaal of hybride domein, op het **[!UICONTROL Detail]** tabblad, bewerkt u de **[!UICONTROL General Settings]** en **[!UICONTROL Login Settings]** en klik op **[!UICONTROL Save]**. Zie voor meer informatie over de instellingen [Gebruikersinstellingen](adding-configuring-users.md#user-settings). U kunt de algemene instellingen en aanmeldingsinstellingen niet bewerken voor een gebruiker die tot een ondernemingsdomein behoort.
1. Als u de groepsinstellingen voor de gebruiker wilt bewerken, klikt u op de knop **[!UICONTROL Group Membership]** en voer de volgende taken uit:

   * Klikken **[!UICONTROL Find Group]** en vult de zoekinformatie in.
   * Als u de gebruiker aan een nieuwe groep wilt toevoegen, schakelt u het selectievakje voor de groep in en klikt u op **[!UICONTROL OK]** en klik vervolgens op **[!UICONTROL Save]**.
...
1. Schakel het selectievakje voor de gebruiker in en klik op **[!UICONTROL Delete]** en klik vervolgens op **[!UICONTROL OK]**.
