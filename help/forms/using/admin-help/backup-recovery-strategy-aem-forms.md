...
**beeld van het Systeem:** een volledige systeemsteun die u kunt gebruiken om de inhoud van uw computer te herstellen als uw harde aandrijving of volledige computer ophoudt werkend. Een back-up van het systeemimage is alleen nodig voordat AEM formulieren worden geïmplementeerd. Het interne bedrijfsbeleid bepaalt dan hoe vaak de steunen van het systeembeeld worden vereist.

**AEM vormen specifieke gegevens:** de gegevens van de toepassing bestaan in gegevensbestand, de Globale Opslag van het Document (GDS), en AEM bewaarplaats, en moeten in echt - tijd worden gesteund. GDS is een map waarin bestanden van lange duur worden opgeslagen die in een proces worden gebruikt. Deze bestanden kunnen PDF, beleidsregels of formuliersjablonen bevatten.
