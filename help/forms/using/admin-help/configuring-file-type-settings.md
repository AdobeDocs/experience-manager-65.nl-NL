...
* Geef op welke instellingen voor bestandstypen standaard moeten worden gebruikt (zie [PDF Generator-configuratiebestanden importeren en exporteren](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md))
...
Deze opties bepalen hoe Microsoft PowerPoint-bestanden worden geconverteerd. Voor instructies over de toegang tot van deze opties raadpleegt u [Instellingen voor bestandstypen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Convert specified styles to bookmarks]**: Hiermee converteert u de stijlen die u in het dialoogvenster **[!UICONTROL Styles with levels]** aan bladwijzers in het PDF-document.
...
Deze opties bepalen hoe AutoCAD-bestanden worden geconverteerd. Voor instructies over de toegang tot van deze opties raadpleegt u [Instellingen voor bestandstypen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
