...
* Geef op welke instellingen voor bestandstypen standaard moeten worden gebruikt (zie [Configuratiebestanden van PDF Generatoren importeren en exporteren](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md))
...
[Instellingen van andere toepassingen (alleen Windows)](/help/forms/using/admin-help/configuring-file-type-settings.md#other-applications-settings-windows-only)
   ...
   Als u naar een andere sectie wilt gaan, klikt u op de koppeling op de webpagina of gebruikt u de opdracht **[!UICONTROL Next]** of **[!UICONTROL Previous]** knoppen.
...
Deze opties bepalen hoe Microsoft PowerPoint-bestanden worden omgezet. Voor instructies over de toegang tot van deze opties raadpleegt u [Instellingen voor bestandstypen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Convert specified styles to bookmarks]**: Zet de stijlen om die u in het dialoogvenster **[!UICONTROL Styles with levels]** aan bladwijzers in het PDF-document.
...
Deze opties bepalen hoe AutoCAD-bestanden worden omgezet. Voor instructies over de toegang tot van deze opties raadpleegt u [Instellingen voor bestandstypen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
...
Deze opties bepalen hoe de dossiers OpenOffice worden omgezet. Voor instructies over de toegang tot van deze opties raadpleegt u [Instellingen voor bestandstypen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
