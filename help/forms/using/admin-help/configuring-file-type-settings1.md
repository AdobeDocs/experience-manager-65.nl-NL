...
* Specificeer welke dossiertype montages aan gebruik door gebrek (zie [ het Invoeren en het uitvoeren van de configuratiedossiers van de PDF Generator ](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html))
...
* [ laat steun PDF/A ](https://helpx.adobe.com/aem-forms/6-2/admin-help/enable-pdf-a-support.html) toe
* [ Schrap een Type dat van het Dossier plaatst ](https://helpx.adobe.com/aem-forms/6-2/admin-help/enable-pdf-a-support.html)
...
**Primaire OCRLanguage:** De taal voor de motor OCR om de karakters te gebruiken te identificeren. De standaardwaarde is Engels (VS).
...
1. Voer de vereiste informatie in deze secties in:
   ...
   [ het Invoeren en het uitvoeren van de configuratiedossiers van de PDF Generator ](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html)
...
1. Als u slechts de in-use subsets van de ingebedde doopvonten wilt inbedden, uitgezochte **Subset alle ingebedde doopvonten**.
   ...
   >[!NOTE]
   >
   >*Als u deze optie in combinatie met **gebruikt bedde sommige doopvonten**, zijn de doopvonten in **A**dd doopvonten aan unembed lijst nog volledig unembedded.*
...
Deze opties bepalen hoe Microsoft PowerPoint-bestanden worden omgezet. Voor instructies over de toegang tot van deze opties, zie [ creeer of geef dossiertype montages ](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings) uit.
...
Deze opties bepalen hoe AutoCAD-bestanden worden omgezet. Voor instructies over de toegang tot van deze opties, zie [ creeer of geef dossiertype montages ](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings) uit.
...
**[!UICONTROL Create PDF/E-1 Compliant File]**: maakt een bestand dat compatibel is met PDF/E-1. PDF/E is een ISO-norm voor de uitwisseling van technische en technische documentatie. Voor meer informatie over PDF/E-1, zie [ Adobe en de industrienormen ](https://www.adobe.com/enterprise/standards/index.html).
...
Deze opties bepalen hoe de dossiers OpenOffice worden omgezet. Voor instructies over de toegang tot van deze opties, zie [ creeer of geef dossiertype montages ](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings) uit.
