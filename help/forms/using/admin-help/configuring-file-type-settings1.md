...
* Geef op welke bestandstypen standaard moeten worden gebruikt (zie [Configuratiebestanden van PDF Generator importeren en exporteren](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html))
...
**Primaire OCRLLanguage:** De taal die de OCR-engine gebruikt om de tekens te identificeren. De standaardwaarde is Engels (VS).
...
Deze opties bepalen hoe Microsoft PowerPoint-bestanden worden geconverteerd. Zie [Bestandstype-instellingen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings) voor instructies over het openen van deze opties.
...
Deze opties bepalen hoe AutoCAD-bestanden worden geconverteerd. Zie [Bestandstype-instellingen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings) voor instructies over het openen van deze opties.
...
**[!UICONTROL Create PDF/E-1 Compliant File]**: Hiermee maakt u een bestand dat compatibel is met PDF/E-1. PDF/E is een ISO-norm voor de uitwisseling van technische en technische documentatie. Zie [Adobe en industriestandaarden](https://www.adobe.com/enterprise/standards/index.html) voor meer informatie over PDF/E-1.
...
Deze opties bepalen hoe de dossiers OpenOffice worden omgezet. Zie [Bestandstype-instellingen maken of bewerken](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings) voor instructies over het openen van deze opties.
