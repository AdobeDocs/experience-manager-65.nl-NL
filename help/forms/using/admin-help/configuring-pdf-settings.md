...
* Geef de standaard PDF-instellingen op. (Zie [De standaardinstellingen wijzigen](/help/forms/using/admin-help/configuring-file-type-settings.md#change-the-default-settings))
* Upload een PDF-instellingenbestand naar de server. (Zie [PDF-instellingen uploaden](configuring-pdf-settings.md#upload-pdf-settings).)
...
**PDF/X-3 2002:** Controleert binnenkomende taken op PDF/X-3-compatibiliteit en maakt alleen PDF-bestanden als deze voldoen. Net als PDF/X-1a is PDF/X-3 een ISO-standaard voor het uitwisselen van grafische inhoud. Het belangrijkste verschil is dat PDF/X-3 apparaatonafhankelijke kleuren ondersteunt.

**Drukwerkkwaliteit:** maakt PDF-bestanden voor afdrukproductie van hoge kwaliteit (bijvoorbeeld op een zetmachine of plaatmachine). In dit geval is bestandsgrootte geen overweging. Het doel is om in een PDF-bestand alle gegevens te behouden die een drukker of prepress-bureau nodig heeft om het document correct af te drukken. Deze set opties:
...
## PDF-instellingen {#upload-pdf-settings} uploaden
...
## PDF-instellingen {#delete-pdf-settings} verwijderen
...
Gebruik de algemene opties om de versie van Acrobat op te geven die u wilt gebruiken voor bestandscompatibiliteit en andere bestands- en apparaatopties. Zie [PDF-instellingen toevoegen of bewerken](configuring-pdf-settings.md#add-or-edit-pdf-settings) voor instructies over het openen van de algemene opties.
...
**Compressie op objectniveau:** consolideert kleine objecten (die afzonderlijk niet kunnen worden gecomprimeerd) in streams die vervolgens efficiënt kunnen worden gecomprimeerd.

**Uit:** comprimeert geen structurele informatie in het PDF-document. Selecteer deze optie als u wilt dat gebruikers met Acrobat 5 en hoger door bladwijzers en andere structuurgegevens kunnen navigeren en deze kunnen gebruiken.

**Alleen codes:** comprimeert structuurgegevens in het PDF-document. Als u deze optie gebruikt, resulteert dit in een PDF-bestand dat met Acrobat 5 kan worden geopend en afgedrukt. Gebruikers kunnen geen toegankelijkheid, structuur of gecodeerde PDF-gegevens weergeven in Acrobat 5 of Acrobat Reader 5.0, maar ze kunnen deze gegevens wel weergeven in Acrobat 6 en Adobe Reader 6.0.
...
**Binding:** Hiermee geeft u op of een PDF-bestand met linker- of rechterbinding moet worden weergegeven. Deze instelling is van invloed op de weergave van pagina&#39;s in de indeling Pagina naast elkaar - Doorlopende lay-out en de weergave van miniaturen naast elkaar.
...
**Breedte:** Breedte van pagina

**Hoogte:** Hoogte van de pagina

**Eenheden:** eenheden voor breedte- en hoogteinstellingen

## Afbeeldingsopties {#images-options}

Met de opties bij Afbeeldingen geeft u compressie en resampling voor afbeeldingen op. U kunt met deze opties experimenteren om een juiste balans te vinden tussen bestandsgrootte en afbeeldingskwaliteit. Zie [PDF-instellingen toevoegen of bewerken](configuring-pdf-settings.md#add-or-edit-pdf-settings) voor instructies voor het openen van de afbeeldingsinstellingen.

Met deze opties configureert u afbeeldingen in kleur, grijswaarden en monochroom:

**Downsample:een waarde** instellen voor elk type afbeelding. In PDF Generator worden pixels in een voorbeeldgebied gecombineerd om afbeeldingen in kleur, grijswaarden of monochroom te downsamplen. Op deze manier wordt één grotere pixel gemaakt. Geef de resolutie van het uitvoerapparaat op in dpi (dots per inch) en voer een resolutie in dpi in het tekstvak Voor afbeeldingen boven in. Voor afbeeldingen met een resolutie die hoger is dan deze drempelwaarde, combineert PDF Generator indien nodig pixels om de resolutie van de afbeelding (pixels per inch) tot de opgegeven dpi-instelling te beperken. Selecteer Uit om downsampling uit te schakelen. Hier volgen de opties:

**Gemiddelde downsampling naar:** Gemiddelt de pixels in een monstergebied en vervangt het gehele gebied door de gemiddelde pixelkleur bij de opgegeven resolutie.

**Bicubische downsampling naar:** Hierbij wordt een gewogen gemiddelde gebruikt om de pixelkleur te bepalen. Dit levert meestal betere resultaten op dan bij de eenvoudige methode voor het nemen van gemiddelde downsampling. Bicubisch is de langzaamste maar meest nauwkeurige methode en resulteert in de meest vloeiende kleurovergangen.

**Subsampling naar:** Hiermee selecteert u een pixel in het midden van het monstergebied en vervangt u het gehele gebied door die pixel met de opgegeven resolutie. Subsampling vermindert significant de omzettingstijd in vergelijking met downsampling, maar het resulteert in beelden die minder vlot en ononderbroken zijn.
...
**Compressie:een waarde** instellen die moet worden toegepast op afbeeldingen in kleur, grijswaarden en monochroom. Voor kleuren- en grijswaardenafbeeldingen stelt u ook de afbeeldingskwaliteit in:
...
**Anti-alias naar grijs:** Hiermee maakt u gekartelde randen vloeiender in monochrome afbeeldingen. Selecteer 2-bits, 4-bits of 8-bits om 4, 16 of 256 grijsniveaus op te geven. (Anti-aliasing kan kleine tekst of dunne lijnen vervagen.)

>[!NOTE]
>
>De compressie van tekst en lijnen is altijd ingeschakeld.

**Beleid voor afbeeldingen:een beleid** instellen voor kleuren-, grijswaarden- en monochrome afbeeldingen. Als de afbeeldingsresolutie lager is dan de opgegeven resolutie, kunt u doorgaan (Negeren), een waarschuwingsbericht opgeven of de taak annuleren.

## Fontopties {#fonts-options}

Met de opties bij Fonts geeft u op welke fonts u wilt insluiten in een PDF-bestand en of u een subset met tekens wilt insluiten die in het PDF-bestand worden gebruikt. Zie [PDF-instellingen toevoegen of bewerken](configuring-pdf-settings.md#add-or-edit-pdf-settings) voor informatie over het openen van lettertypeopties.

>[!NOTE]
>
>Wanneer u PDF-bestanden combineert met dezelfde fontsubset, probeert PDF Generator de fontsubsets te combineren.

**Alle fonts insluiten:Alle fonts** die in het bestand worden gebruikt, worden ingesloten. Lettertypen moeten worden ingesloten voor compatibiliteit met PDF/X.
...
**Wanneer insluiten mislukt:** Hiermee geeft u op hoe PDF Generator reageert als er bij de verwerking van een bestand geen font voor insluiting wordt gevonden. U kunt de PDF Generator de aanvraag laten negeren en het font vervangen, u waarschuwen en het font vervangen of de verwerking van de huidige taak annuleren.

**Fontbron:** de locatie van de fonts die in de PDF Generator worden gebruikt.
...
Met de kleuropties stelt u alle kleurbeheerinformatie in voor de PDF-generator. Zie [PDF-instellingen toevoegen of bewerken](configuring-pdf-settings.md#add-or-edit-pdf-settings) voor instructies over het openen van de kleuropties.
...
**Behouden:** betekent dat de intentie wordt opgegeven in het uitvoerapparaat en niet in het PDF-bestand. In veel uitvoerapparaten is Relatief colorimetrisch de standaardintentie.
...
**Verzadiging:** handhaaft de relatieve verzadigingswaarden van de oorspronkelijke pixels. Deze methode is geschikt voor zakelijke afbeeldingen, waarbij de exacte relatie tussen kleuren niet zo belangrijk is als heldere verzadigde kleuren.
...
**CMYK:** definieert de kleurruimte van alle CMYK-afbeeldingen in bestanden. De standaardwaarde is U.S. Web Coated (SWOP) v2. U kunt ook Geen selecteren om te voorkomen dat CMYK-afbeeldingen worden geconverteerd.
...
**Verwijderen:Alle toegepaste overdrachtsfuncties** verwijderen. Verwijder toegepaste overdrachtsfuncties tenzij het PDF-bestand wordt uitgevoerd naar hetzelfde apparaat waarvoor het bron-PostScript-bestand is gemaakt.

**Halftoongegevens behouden:halftoongegevens** blijven behouden in bestanden. Halftooninformatie bestaat uit stippen die bepalen hoeveel halftoonapparaten met inkt op een specifieke locatie op het papier worden neergezet. Door de puntgrootte en de dichtheid te variëren, lijkt het alsof de kleur grijs of doorlopend is. Voor een CMYK-afbeelding worden vier halftoonrasters gebruikt, één voor elke inkt die in het afdrukproces wordt gebruikt.
...
**PostScript-bestand toestaan om Adobe PDF-instellingen te overschrijven:** gebruikt instellingen die zijn opgeslagen in een PostScript-bestand in plaats van het huidige Adobe PDF-instellingenbestand. Voordat u een PostScript-bestand verwerkt, kunt u parameters in het bestand plaatsen om de volgende aspecten te beheren:
...
**PostScript-XObjecten toestaan:** PostScript XObjects slaan informatie op die op veel pagina&#39;s van hetzelfde bestand wordt weergegeven, zoals een achtergrondafbeelding of kop- en voettekstinformatie. Het gebruik van PostScript XObjects kan resulteren in sneller afdrukken, maar vereist meer printergeheugen. Als u wilt voorkomen dat PostScript-XObjects worden gemaakt, schakelt u deze optie uit als u PDF-bestanden maakt met compatibiliteit met Acrobat 5 (PDF 1.4) of hoger.

**Verlopen converteren naar vloeiende schaduwen:** hiermee converteert u overvloeiingen naar vloeiende schaduwen voor Acrobat 4 en hoger, waardoor PDF-bestanden kleiner worden en de kwaliteit van de uiteindelijke uitvoer kan verbeteren. De Generator PDF zet gradiënten van Adobe Illustrator, Adobe InDesign, Adobe FreeHand MX, CorelDraw, Quark Xpress, en Microsoft PowerPoint om.

**Vloeiende lijnen converteren naar curven:** hiermee verkleint u het aantal controlepunten dat wordt gebruikt om curven op te bouwen in CAD-tekeningen. Dit levert kleinere PDF&#39;s op en resulteert in snellere rendering op het scherm.
...
**Oorspronkelijke JPEG-afbeeldingen opslaan in PDF, indien mogelijk:** verwerkt gecomprimeerde JPEG-afbeeldingen (afbeeldingen die al zijn gecomprimeerd met DCT-codering) zonder ze opnieuw te comprimeren. Als deze optie is geselecteerd, worden JPEG-afbeeldingen in de PDF-generator gedecomprimeerd om te voorkomen dat ze beschadigd raken. Geldige afbeeldingen worden echter niet opnieuw gecomprimeerd, waardoor de oorspronkelijke afbeelding ongewijzigd wordt verwerkt. Als deze optie is geselecteerd, verbeteren de prestaties omdat alleen decompressie (geen recompressie) optreedt en de afbeeldingsgegevens en metagegevens behouden blijven.

**Portable Job Ticket opslaan in PDF-bestand:een PostScript-opdrachtticket** blijft behouden in een PDF-bestand. Het opdrachtticket bevat informatie over het PostScript-bestand, zoals het paginaformaat, de resolutie en overvullingsgegevens, in plaats van informatie over de inhoud. Deze informatie kan later in een werkstroom of voor druk worden gebruikt PDF.

**Gebruik Prolog.ps en Epilog.ps:** verzendt een proloog- en epiloogbestand met elke taak. Deze bestanden hebben vele doeleinden. Profielbestanden kunnen bijvoorbeeld worden bewerkt om omslagpagina&#39;s op te geven. Epiloogbestanden kunnen worden bewerkt om een reeks procedures in een PostScript-bestand op te lossen. U kunt de bestanden uploaden of downloaden. (Zie Prologue- en epiloogbestanden uploaden en downloaden.)

**DSC-opmerkingen verwerken:DSC-informatie uit een PostScript-bestand** blijft behouden. Deze subopties zijn beschikbaar:

**Logboek DSC Waarschuwingen:** Toont waarschuwingsberichten over problematische commentaren DSC tijdens verwerking en voegt hen aan een logboekdossier toe.

**EPS-informatie uit DSC behouden:** behoudt informatie, zoals de brontoepassing en aanmaakdatum voor een EPS-bestand. Als deze optie is uitgeschakeld, wordt de grootte en het midden van de pagina gebaseerd op de linkerbovenhoek van het object linksboven en de rechterbenedenhoek van het object rechtsonder op de pagina.

**OPI-opmerkingen behouden:** behoudt de informatie die nodig is om een FPO-afbeelding (For Placement Only) te vervangen of om opmerkingen toe te voegen aan de afbeelding met hoge resolutie op servers die OPI-versies 1.3 en 2.0 (Open Prepress Interface) ondersteunen.

**Documentinformatie uit DSC behouden:** Behoudt informatie zoals titel, aanmaakdatum en tijd. Wanneer u een PDF-bestand opent in Acrobat, wordt deze informatie weergegeven in het venster Beschrijving van documenteigenschappen.

**Pagina vergroten/verkleinen en Illustraties centreren voor EPS-bestanden:** centreert een EPS-afbeelding en past de grootte van de pagina aan zodat deze precies rond de afbeelding past. Deze optie is alleen van toepassing op taken die uit één EPS-bestand bestaan.

## Opties voor rapportage en naleving van standaarden {#standards-reporting-and-compliance-options}
...
**Wanneer niet compatibel:** geeft aan of het PDF-bestand moet worden gemaakt als het PostScript-bestand niet voldoet aan PDF/X-vereisten. Deze optie is beschikbaar wanneer de Norm van de Naleving op de pagina van de Rapportering en van de Naleving van Normen aan een andere optie dan niets wordt geplaatst.

**Doorgaan:** maakt een PDF-bestand.

**Taak annuleren:** maakt alleen een PDF-bestand als het PostScript-bestand voldoet aan de PDF/X-vereisten van de geselecteerde rapportopties en anderszins geldig is. Als beide PDF/X-rapportopties zijn geselecteerd en het PostScript-bestand slechts aan één set PDF/X-criteria voldoet (bijvoorbeeld PDF/X-3), maakt de PDF Generator het compatibele bestand.

**Als noch TrimBox noch ArtBox wordt gespecificeerd:** Beschikbaar wanneer de Norm van de Naleving op de pagina van de Rapportering en van de Normen aan een andere optie dan niets wordt geplaatst.

**Rapport als fout:** markeert het PostScript-bestand als niet-compatibel als een van de rapportopties is geselecteerd en een bijsnijdvak of illustratievak ontbreekt op een pagina.

**TrimBox instellen op MediaBox met verschuivingen:** Berekent waarden in punten voor het bijsnijdvak op basis van de verschuivingen voor het mediavak van de respectieve pagina&#39;s als noch het bijsnijdvak, noch het illustratievak is opgegeven. Het bijsnijdvak is altijd zo klein of kleiner dan het omsluitende mediavak.

**Als BleedBox niet is opgegeven:** beschikbaar als de compatibiliteitsnorm op de pagina Normen rapporteren en naleven is ingesteld op een andere optie dan Geen.

**BleedBox instellen op MediaBox:** gebruikt de waarden voor het mediavak voor het afloopvak als het afloopvak niet is opgegeven.
...
**Standaardwaarden indien niet opgegeven in het document:** Deze optie is beschikbaar wanneer de compatibiliteitsnorm op de pagina Normen rapporteren en Naleving is ingesteld op een andere optie dan Geen.

**Uitvoerintentieprofielnaam:** geeft de gekarakteriseerde afdrukvoorwaarde aan waarvoor het document is voorbereid. Als in een document geen naam voor een uitvoerintentie is opgegeven, gebruikt de PDF Generator de geselecteerde waarde in dit menu. U kunt een van de opgegeven namen selecteren of een naam invoeren in de beschikbare ruimte. Selecteer Geen als de workflow vereist dat het document de uitvoerintentie opgeeft. Een document dat niet aan de vereisten voldoet, kan niet worden gecontroleerd op de naleving.

**Uitvoervoorwaarde-id:** geeft de referentienaam aan die is opgegeven in het register van de uitvoerintentieprofielnaam.

**Uitvoervoorwaarde:** beschrijft de bedoelde afdrukvoorwaarde. Dit item kan handig zijn voor de ontvanger van het PDF-document.
...
**Overvulling:** geeft de status van overvulling in het document aan. Voor compatibiliteit met PDF/X is de waarde Waar of Onwaar vereist. Als het document de overvulstatus niet opgeeft, wordt de hier opgegeven waarde gebruikt. Selecteer Ongedefinieerd laten als uw werkstroom vereist dat het document de overvulstatus opgeeft. Een document dat niet aan de vereisten voldoet, kan niet worden gecontroleerd op de naleving.
...
**Wanneer niet compatibel:** geeft aan of het PDF-bestand moet worden gemaakt als het PostScript-bestand niet voldoet aan PDF/A-vereisten.

**Doorgaan:** maakt een PDF-bestand, zelfs als het PostScript-bestand niet voldoet aan de vereisten van de standaard.

**Taak annuleren:** maakt alleen een PDF-bestand als het PostScript-bestand voldoet aan PDF/A-vereisten en anderszins geldig is.

**Uitvoerintentieprofielnaam:** geeft de gekarakteriseerde afdrukvoorwaarde aan waarvoor het document is voorbereid en die vereist is voor PDF/A-compatibiliteit. Selecteer Geen als de workflow vereist dat in het document uitvoerintentiegegevens worden opgegeven. Als deze informatie niet is opgegeven, wordt niet gecontroleerd of het document aan de voorschriften voldoet.

**Uitvoervoorwaarde:** beschrijft de bedoelde afdrukvoorwaarde. Dit item is niet vereist, maar kan worden gebruikt om nuttige informatie te verstrekken aan de beoogde ontvanger van het PDF-document.

## Oorspronkelijke weergaveopties {#initial-view-options}

Deze opties zijn onderverdeeld in drie gebieden: Documentopties, Vensteropties en Interfaceopties. Zie [PDF-instellingen toevoegen of bewerken](configuring-pdf-settings.md#add-or-edit-pdf-settings) voor instructies over het openen van de opties voor de weergave bij openen.
...
**Tonen:** Hiermee bepaalt u standaard welke deelvensters en tabbladen in het toepassingsvenster worden weergegeven. In het venster Bladwijzers en op de pagina wordt het documentvenster geopend en wordt het tabblad Bladwijzers weergegeven.
...
**Openen naar paginanummer:** Hiermee stelt u de pagina in waarop het document wordt geopend, doorgaans pagina 1.
...
**Venster vergroten/verkleinen tot eerste pagina:** Hiermee past u het documentvenster aan zodat het precies rond de openingspagina past, afhankelijk van de opties die u onder Documentopties hebt geselecteerd.
...
### Opties voor gebruikersinterface {#user-interface-options}
...
**Werkbalken verbergen:** indien geselecteerd, worden de werkbalken verborgen

**Vensterbalk verbergen:** indien geselecteerd, worden de vensterbesturingselementen verborgen
...
## Prologue- en epiloogbestanden uploaden en downloaden {#uploading-and-downloading-prologue-and-epilogue-files}
...
### Een proloog- of epiloogbestand {#download-a-prologue-or-epilogue-file} downloaden
...
### Een proloog- of epiloogbestand {#upload-a-prologue-or-epilogue-file} uploaden
