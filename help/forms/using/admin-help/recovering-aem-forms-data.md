...
1. Herstel de GDS-map door eerst de inhoud van de GDS-map te verwijderen bij de bestaande installatie van AEM formulieren en vervolgens de inhoud van de GDS-map te kopiëren uit de GDS-map waarvan een back-up is gemaakt. Als u de GDS-maplocatie hebt gewijzigd, zie [De GDS-locatie wijzigen tijdens de herstelbewerking](recovering-aem-forms-data.md#changing-the-gds-location-during-recovery).
