...
1. Op het **[!UICONTROL Allow]** gebied, **uitgezocht** Alle gebruikers - Alle gebruikers, anoniem of het programma geopend, kunnen voorproef gehechtheid, vormen verifiëren en ondertekenen, en klikken **[!UICONTROL Save].** Auteurinstantie is geconfigureerd voor gebruik van [!DNL Adobe Sign] .
