...
seo-description: Leer hoe u uw op XFA gebaseerde HTML5 Forms kunt afstemmen voor de beste prestaties.
...
## Knooppunten zijn valuta voor HTML5-formulieren en geven ze verstandig uit {#nodes-are-currency-of-html-forms-spend-them-wisely}
...
## De formulieren van Lite presteren beter, houden de middelen gecomprimeerd {#lite-forms-perform-better-keep-the-resources-compressed}
...
* Gebruik de minify optie in AEM Configuration Manager (Day CQ HTML Library Manager) om JavaScript- en CSS-bestanden te comprimeren. Zie [OSGi Configuration Settings](/help/sites-deploying/osgi-configuration-settings.md) voor meer informatie.
* Webcompressie inschakelen. Hiermee verkleint u de grootte van de aanvragen en reacties die afkomstig zijn van een formulier. Zie [Prestaties van AEM formulierserver](https://helpx.adobe.com/aem-forms/6-3/performance-tuning-aem-forms.html) voor meer informatie.
...
## Aanbevolen lezen {#recommended-reads}
