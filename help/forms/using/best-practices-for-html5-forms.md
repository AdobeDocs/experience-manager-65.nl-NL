...
* Houd het aantal Draw-tekstelementen op een formulier tot een minimum beperkt. Draw-elementen zijn handig voor het verbeteren van de leesbaarheid en het uiterlijk, maar beschikken niet over opslagmogelijkheden voor informatie. Het wordt aangeraden meerdere Draw-tekstelementen samen te voegen tot één Draw-tekstelement. Laat geen steen ongedraaid om een formulier leaner te maken.
...
* [ de server van AEM Forms sluit geen doopvonten aan een Dynamische vorm van PDF in ](https://helpx.adobe.com/aem-forms/kb/aem-forms-server-does-not-embed-fonts-to-dynamic-pdf-form.html)
