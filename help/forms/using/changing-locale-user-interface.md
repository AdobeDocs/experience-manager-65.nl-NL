...
>[!NOTE]
>
>Als u de taal van het aanmeldingsscherm van de AEM Forms-werkruimte wilt wijzigen, raadpleegt u [Een nieuw aanmeldingsscherm maken](../../forms/using/creating-new-login-screen.md).
