...
1. Sleep een **[!UICONTROL Numeric Box]** component vóór de voettekstcomponent. Open eigenschappen van de component, stel waarden in die in de onderstaande tabel worden vermeld, en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Sleep een **[!UICONTROL Email]** component vóór de voettekstcomponent. Open eigenschappen van de component, stel waarden in die in de onderstaande tabel worden vermeld en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Sleep een **[!UICONTROL File Attachment]** component vóór de voettekstcomponent. Open eigenschappen van de component, stel waarden in die in de onderstaande tabel worden vermeld en tik ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
