...
1. Tikken **Maken** en selecteert u **Interactieve communicatie**. De **Interactieve communicatie maken** wordt weergegeven.
1. Opgeven **create_first_ic** in de **Titel** en de **Naam** veld. Selecteren **FDM_Create_First_IC** als het formuliergegevensmodel en tik op **Volgende**.
1. In de **Kanalen** wizard:
   ...
   1. Opgeven **Create_First_IC_templates** map > **Create_First_IC_Web_Template** als websjabloon en tik op **Selecteren**.

   1. Tikken **Maken**.

   Er wordt een bevestigingsbericht weergegeven dat de interactieve communicatie is gemaakt.

1. Tikken **Bewerken** om de Interactieve Communicatie in de juiste ruit te openen.
...
1. Tikken **Grafieken** doelgebied en tikken **+** om een **Diagram** component.
1. Tik op de component Chart en selecteer ![configure_icon](assets/configure_icon.png) (Configureren). De grafiekeigenschappen worden weergegeven in het linkerdeelvenster:

   1. Geef een naam op voor het diagram.
   1. Selecteren **Schijf** van de **Type diagram** vervolgkeuzelijst.
   1. Selecteer **calltype** eigenschap van de **oproepen** objecttype gegevensmodel in **X-as** sectie. Tikken ![done_icon](assets/done_icon.png).
   1. Selecteren **Frequentie** van de **Functie** vervolgkeuzelijst.
   1. Selecteer **calltype** eigenschap van de **oproepen** objecttype gegevensmodel in **Y-as** sectie. Tikken ![done_icon](assets/done_icon.png).
...
1. Selecteer het tekstveld in het dialoogvenster **Datum** kolom en tik ![configure_icon](assets/configure_icon.png) (Configureren).
1. Selecteren **Gegevensmodelobject** van de **Type binding** vervolgkeuzelijst en selecteer **oproepen** > **calldate**. Tikken ![done_icon](assets/done_icon.png) twee keer om de eigenschappen op te slaan.
...
1. Tikken **Nu betalen** doelgebied en tikken **+** om een **Afbeelding** component.
1. Tik op de component Image en selecteer ![configure_icon](assets/configure_icon.png) (Configureren). De eigenschappen van de afbeelding worden weergegeven in het linkervenster:

   1. Opgeven **Nu betalen** als de naam van de afbeelding in het dialoogvenster **Naam** veld.
   1. Tikken **Uploaden** selecteert u de afbeelding die u in het lokale bestandssysteem hebt opgeslagen en tikt u op **Openen**.
   1. Tikken ![done_icon](assets/done_icon.png) om de eigenschappen van de afbeelding op te slaan.
...
1. Tikken **Bewerken** om de Interactieve Communicatie in de juiste ruit te openen.
1. Tik op de knop **Kanalen** van het linkervenster en tik **Web**.
1. Ga naar de **Activa** en pas het filter toe om alleen de documentfragmenten in het linkervenster weer te geven.
1. Sleep de volgende documentfragmenten naar het doelgebied in de interactieve communicatie.
...
1. Tikken **Overzicht van heffingen** doelgebied en tikken **+** om een **Diagram** component.
1. Tik op de component Chart en selecteer ![configure_icon](assets/configure_icon.png) (Configureren). De grafiekeigenschappen worden weergegeven in het linkerdeelvenster:
...
1. Selecteer **Bijschrift** tabelkolomkop en tik ![bewerken](assets/edit.png) (Bewerken) om de naam van de tekst te wijzigen in **Aanroepingsdatum**. Wijzig de naam van de andere kolomkoppen in de tabel.
...
1. Maak de hyperlinktekst zodanig op dat deze als een knop in de interactieve communicatie wordt weergegeven. Ga hierbij als volgt te werk:
   ...
   1. In de **Rand** sectie, specificeren **1,5 px** als **Randbreedte**, selecteert u **Effen** als **Randstijl** en **46 px** als **Straal rand**.

   1. Selecteer Rood als achtergrondkleur voor de knop in het menu **Achtergrond** sectie.
   1. In de **Marge** veld voor **Dimension en positie** tikken op de **Tegelijkertijd bewerken** en stelt de **Rechts** marge als **450 px**. De velden Boven, Onder en Links worden ingesteld als leeg.
...
1. Tik op de component Image en selecteer ![configure_icon](assets/configure_icon.png) (Configureren). De eigenschappen van de afbeelding worden weergegeven in het linkervenster:
   ...
   1. Tikken **Uploaden**, selecteert u de **PayNowWeb** opgeslagen afbeelding op het lokale bestandssysteem en tikt u op **Openen**.
...
1. In de **Kanalen** wizard:
   ...
   1. Selecteer **Afdrukken gebruiken als Master voor webkanaal** selectievakje.
   1. Opgeven **Create_First_IC_templates** map > **Create_First_IC_Web_Template** als websjabloon en tik op **Selecteren**.
...
1. Tikken **Bewerken** om de Interactieve Communicatie in de juiste ruit te openen.
1. Voer stap 6 - 15 uit van [Interactieve communicatie voor afdrukkanaal maken](../../forms/using/create-interactive-communication0.md#create-interactive-communication-for-print-channel) sectie.
1. Tik op de knop **Kanalen** van het linkervenster en tik **Web** om automatisch inhoud voor het webkanaal te genereren via het kanaal Afdrukken.
1. Als de **Afdrukken gebruiken als Master voor webkanaal** Schakel het selectievakje in in stap 4. De inhoud en bindingen worden automatisch gegenereerd voor het webkanaal via het kanaal Afdrukken.
   ...
   Houd de muisaanwijzer boven het desbetreffende doelgebied in het webkanaal en selecteer ![cancelovererving](assets/cancelinheritance.png) (Overerving annuleren) en vervolgens in het dialoogvenster **Overerving annuleren** dialoogvenster, tikken **Ja**.

   ![Overerving annuleren](assets/cancel_inheritance_web_channel_new.png)

   Als u de overerving van een component hebt geannuleerd, kunt u deze opnieuw inschakelen. Als u overerving weer wilt inschakelen, plaatst u de muisaanwijzer boven de grens van het desbetreffende doelgebied, inclusief de component, en tikt u op ![reenableerbaarheid](assets/reenableinheritance.png).

1. Selecteer **Inhoud** in het linkerdeelvenster.
