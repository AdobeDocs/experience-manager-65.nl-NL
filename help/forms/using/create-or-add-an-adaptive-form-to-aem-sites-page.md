...
1. Meld u aan bij uw AEM-auteur en open CRX DE. De standaard-URL voor een instantie van de Auteur die lokaal wordt uitgevoerd `http://localhost:4502/crx/de`.
