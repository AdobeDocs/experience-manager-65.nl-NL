...
1. Op de **[!UICONTROL Add Properties]** stap voor het maken van aangepaste formulieren, tik op de knop **[!UICONTROL Form Model]** tab.
...
1. Selecteer het aangepaste formulier en tik op het **Eigenschappen** pictogram.
