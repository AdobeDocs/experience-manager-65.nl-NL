...
* Een gecontroleerde map heeft verschillende eigenschappen. Zie [Gecontroleerde mapeigenschappen](/help/forms/using/watched-folder-in-aem-forms.md#main-pars-header-1).
