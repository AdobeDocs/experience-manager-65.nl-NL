...
1. Open de logboeken om het type van fout te identificeren. Voor gedetailleerde informatie over logboeken, zie [ logboeken voor HTML5 vormen ](/help/forms/using/enable-logs.md).
...
1. Bepaal de plaats van de serverlogboeken zoals vermeld bij [ Logboeken voor de vormen HTML5 ](/help/forms/using/enable-logs.md). Controleer of er tijdens de verzending een fout is opgetreden in de serverlogboeken.
