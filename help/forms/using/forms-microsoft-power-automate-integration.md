...
| -------- | ---------------------------- |
| AEM 6.5 | Dit artikel |
| AEM as a Cloud Service | [&#x200B; klik hier &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-manager-cloud-service/content/forms/integrate/set-submit-action/forms-microsoft-power-automate-integration) |
...
1. Login aan [&#x200B; Portaal van Azure &#x200B;](https://portal.azure.com/).
...
1. Geef de naam, ondersteunde accounttypen en de URI omleiden op de pagina op. Geef in de URI voor omleiding het volgende op en klik op Opslaan.
   ...
   * `https://[AEM Forms Author instance]/libs/fd/powerautomate/content/flowservice/config.html`
   ...
   ![&#x200B; registreer een Toepassing van de Folder van Azure Actieve &#x200B;](assets/power-automate-application.png)
...
1. Geef op de pagina **[!UICONTROL Configure Dataverse Service for Microsoft®® Power Automate]** de waarden **[!UICONTROL Client ID]** (ook wel toepassings-id genoemd), **[!UICONTROL Client Secret]** , **[!UICONTROL OAuth URL]** en **[!UICONTROL Dynamic Environment URL]** op. Gebruik identiteitskaart van de Cliënt, Geheime Cliënt, OAuth URL, en Dynamische Milieu URL van [&#x200B; Microsoft® Azure Actieve Toepassing van de Folder &#x200B;](#ms-power-automate-application) u in de vorige sectie creeerde. Gebruik de optie Eindpunten in de gebruikersinterface van de Microsoft® Azure Active Directory om OAuth URL te zoeken
...
>[!IMPORTANT]
>
>Tokens die worden gebruikt voor de Microsoft® Power Automate-verbinding verlopen na 90 dagen.
>
> Om de integratie het werk te houden, herauthenticeer en herpubliceer zowel de Macht Microsoft® Automate Data en de de wolkenconfiguraties van de Dienst van de Stroom van de Macht van Microsoft® Automate vóór of wanneer het teken verloopt, gebruik de stappen die bij [&#x200B; worden gedocumenteerd publiceren zowel de Macht van Microsoft® Data en Microsoft® Macht Automate de Kloudconfiguraties van de Stroom van de Dienst &#x200B;](#publish-microsoft-power-automate-dataverse-cloud-configuration).
>
> Voor details op symbolisch levenbeleid, zie de [&#x200B; documentatie van Entra van Microsoft op configureerbare tokenlevens &#x200B;](https://learn.microsoft.com/en-us/entra/identity-platform/configurable-token-lifetimes#token-lifetime-policies-for-refresh-tokens-and-session-tokens). Als het token niet wordt vernieuwd, kunnen formulierverzendingen naar Power Automate mislukken.
