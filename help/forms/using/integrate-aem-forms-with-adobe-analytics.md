...
![Overzicht van analysemogelijkheden](/help/forms/using/assets/analytics-workflow.png)
...
>[!NOTE]
>In beide gevallen [Verouderde analyse](/help/forms/using/configure-analytics-forms-documents.md) en de functies Analytics starten zijn tegelijk ingeschakeld, **Analyse starten** heeft voorrang.
...
1. Tik op het veld en selecteer ![Regeleditor](/help/forms/using/assets/edit-rules-icon.svg) om de pagina van de regelredacteur te openen.
