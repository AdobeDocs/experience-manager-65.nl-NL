...
De OData Cloud-service en het formuliergegevensmodel met vooraf geconfigureerde entiteiten en services voor Microsoft Dynamics zijn alleen beschikbaar in uw AEM Forms-instantie als de uitvoermodus voor de AEM-instantie is ingesteld als `samplecontent`(standaard). Voor meer informatie bij het vormen looppaswijzen voor een instantie AEM, zie de Wijzen van de [Looppas](/help/sites-deploying/configure-runmodes.md).

## Vereisten {#prerequisites}

Alvorens u begint opstelling en vormt de Dynamica van Microsoft, zorg ervoor dat u hebt:

* Het invoegpakket voor [AEM-formulieren is geïnstalleerd](../../forms/using/installing-configuring-aem-forms-osgi.md)
...
1. Selecteer configuratie **MS Dynamics OData Cloud Service (OData Service)** en tik op **[!UICONTROL Eigenschappen]**. Het dialoogvenster voor de configuratie-eigenschap van de cloudservice wordt geopend.
...
1. Klik op **[!UICONTROL Verbinden met OAuth]**. U wordt opnieuw gericht aan de login van de Dynamica van Microsoft pagina.
