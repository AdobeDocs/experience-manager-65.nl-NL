...
**Zoeken in taken**: Zoek naar taakinstanties met een user-defined onderzoeksfilter die op taakattributen wordt gebaseerd.
...
1. Klik op **Ad-hocquery&#39;s** en klik vervolgens op **Proces/taak zoeken**.
...
* **Annuleren**: Wijzigingen annuleren en teruggaan naar de **Mijn filters** deelvenster.
...
1. Als u een query wilt uitvoeren, klikt u op het filter in het dialoogvenster **Mijn filters** of klik op **Uitvoeren** als u een filter maakt of bewerkt.
