...
1. Ga naar de URL https://[server]:[port]/lc/bin/querybuilder.json
...
[Ondersteuning voor bestands](assets/sample-report-pkg-1.zip)[contact ophalen](https://www.adobe.com/account/sign-in.supportportal.html)
