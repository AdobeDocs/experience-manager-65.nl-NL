---
title: Reader-PDF-documenten die met een beleid zijn beveiligd, uitbreiden met de Portable Protection-bibliotheek
seo-title: Reader-PDF-documenten die met een beleid zijn beveiligd, uitbreiden met de Portable Protection-bibliotheek
description: Reader-extensies schakelen interactieve functies in Adobe PDF-documenten in via Acrobat Reader. Met de Portable Protection Library (PPL) kunt u de met DRM beveiligde PDF-documenten uitbreiden.
seo-description: Reader-extensies schakelen interactieve functies in Adobe PDF-documenten in via Acrobat Reader. Met de Portable Protection Library (PPL) kunt u de met DRM beveiligde PDF-documenten uitbreiden.
...
# Reader-PDF-documenten die met een beleid zijn beveiligd, uitbreiden met de Portable Protection-bibliotheek {#reader-extending-policy-protected-pdf-documents-using-portable-protection-library}
...
Met documentbeveiliging kunt u de toegang van specifieke PDF-documenten beperken tot alleen geautoriseerde gebruikers. U kunt ook bepalen hoe een ontvanger een beveiligd document kan gebruiken. U kunt bijvoorbeeld opgeven of ontvangers tekst van een document dat met een beveiligingsbeleid is beveiligd, kunnen afdrukken, kopiëren of bewerken. Zie [over documentbeveiliging](/help/forms/using/admin-help/document-security.md)voor meer informatie over documentbeveiliging.

U kunt Reader-extensies gebruiken om interactieve functies in Adobe PDF-documenten in te schakelen via Acrobat Reader. Deze interactieve functies zijn gewoonlijk alleen beschikbaar via Adobe Acrobat Professional en Standard. Zie de [Adobe Experience Manager Forms DocAssurance-service](/help/forms/using/overview-aem-document-services.md)**voor meer informatie over de interactieve functies die de reader-extensie kan inschakelen.**
...
## Reader-PDF-documenten die met beveiligingsbeleid zijn beveiligd, uitbreiden {#reader-extending-document-security-policy-protected-pdf-documents}
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Geef InputStream op die het PDF-document vertegenwoordigt waaruit gebruiksrechten<br /> moeten worden verwijderd. U kunt met LiveCycle Rights Management of AEM Forms beveiligde documenten gebruiken.</td>
  </tr>
 </tbody>
</table>
