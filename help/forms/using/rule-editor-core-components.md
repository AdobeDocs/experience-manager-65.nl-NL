...
**voorwaarde-actie** In deze constructie, bepaalt een regel eerst een voorwaarde die door een actie wordt gevolgd om teweeg te brengen. De constructie is vergelijkbaar met `if-then statement` in de programmeertalen.
...
* Zorg ervoor dat de [&#x200B; kerncomponent en specificatieversie aan de recentste versie &#x200B;](https://github.com/adobe/aem-core-forms-components/tree/release/650) wordt geplaatst om deze eigenschap in de regelredacteur te gebruiken.
