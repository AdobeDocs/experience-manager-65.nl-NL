...
1. Upgrade de bestaande AEM naar AEM 6.5. De stappen worden hieronder weergegeven:
   ...
   1. Voer een upgrade uit van uw AEM naar AEM 6.3. Zie [Upgraden naar AEM 6.5](/help/sites-deploying/upgrade.md) voor stapsgewijze instructies.
      ...
      >[!NOTE]
      >
      >Nadat de server is gestart, blijven enkele AEM Forms-bundels in de installatiestatus staan. Het aantal bundels kan voor elke installatie variëren. U kunt de status van deze bundels veilig negeren. De bundels worden vermeld op https://&#39;[server]:[poort]&#39;/system/console/.
