...
Het kanaal van de druk van een Interactieve Communicatie gebruikt XFA vormmalplaatje, XDP. Een XDP is ontworpen in Adobe Forms Designer. Zie [Lay-outontwerp](../../forms/using/layout-design-details.md)voor meer informatie over het maken van afdruksjablonen. Als u een sjabloon voor een afdrukkanaal wilt gebruiken in uw interactieve communicatie, moet u de sjabloon uploaden naar de AEM Forms-server.
...
1. Maak een sjabloonmap om uw interactieve communicatiesweb-sjablonen te behouden, als u dat nog niet hebt. Zie Sjabloonmappen in [paginasjablonen - Bewerkbaar](/help/sites-developing/page-templates-editable.md)voor meer informatie.
   ...
   1. Tik op **[!UICONTROL Tools]** de ![gereedschappen](assets/tools.png) > **[!UICONTROL Configuration Browser]**.
...
1. Schakel de sjabloon in als u het gebruik van deze sjabloon voor het maken van interactieve communicatie wilt toestaan.
   ...
   1. Tik op **[!UICONTROL Tools]** de ![gereedschappen](assets/tools.png) > **[!UICONTROL Templates]**.
...
![Kanaal afdrukken als master](assets/create_ic_print_master_new.png) ![webkanaal met afdrukkanaal als master](assets/create_ic_print_master_web_new.png)
