...
* [Het framework voor vertaalintegratie configureren](/help/sites-administering/tc-tic.md) - Een lijst met geselecteerde vertaalconnectors bekijken en leren hoe u het vertaalintegratieframework kunt configureren voor integratie met vertaalservices van derden.
* [Verbinding maken met Microsoft Translator](/help/sites-administering/tc-msconf.md) - AEM levert een Microsoft Translation-account voor testdoeleinden.
