...
Deze map bevat de [CLI-haken](https://cordova.apache.org/docs/en/10.x/guide/appdev/hooks/). De mappen in de map hooks bevatten node.js-scripts die op exacte punten worden uitgevoerd tijdens de build.
