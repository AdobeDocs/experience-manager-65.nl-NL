...
Zoals beschreven in [Paginasjablonen AEM](/help/mobile/apps-architecture.md), kan elke component een JavaScript-fragment uitvoeren om de JSON-inhoud te verbruiken die door de `data` beloven. Na de conventies van de Angular, zou een controlemechanisme slechts voor het toewijzen van variabelen aan het werkingsgebied moeten worden gebruikt.
