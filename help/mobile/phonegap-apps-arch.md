...
Deze folder bevat de [ haken CLI ](https://cordova.apache.org/docs/en/10.x/guide/appdev/hooks/). De omslagen in de hooks folder bevatten knoop.js manuscripten die op nauwkeurige punten tijdens de bouwstijl worden uitgevoerd.
...
Zodra u over de Anatomie van een app hebt geleerd, zie [ Enige Toepassingen van de Pagina ](/help/mobile/phonegap-single-page-applications.md).
