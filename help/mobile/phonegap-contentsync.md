...
>[!NOTE]
>
>Zie [Handlers voor inhoudssynchronisatie ontwikkelen](/help/mobile/contentsync-app-handlers.md) voor meer informatie over richtlijnen voor het ontwikkelen van handlers voor inhoudssynchronisatie.
...
**** contentRender-inhoud met gebruik van de standaardverwerking van een sorteeraanvraag.
