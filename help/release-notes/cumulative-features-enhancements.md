...
* _Dynamische Momentopname van Media 1}_**- Experimenteer met testbeelden of Dynamische Media URLs, om de output van verschillende beeldbepalingen, en Slimme optimalisaties van het Beeld voor dossiergrootte (met levering WebP en AVIF), netwerkbandbreedte, en de Verhouding van het Pixel van het Apparaat te zien.**Zie [ Dynamische Momentopname van Media ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/images/dynamic-media-snapshot.html).
