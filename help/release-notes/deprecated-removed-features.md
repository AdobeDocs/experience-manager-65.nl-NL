...
| Schermen | De Adobe is niet van plan om de bundel com.adobe.cq.screens.mq.activemq en verwante configuraties verder te handhaven en bij te werken die voor opstelling 2Publishers worden gebruikt. | Adobe raadt klanten aan die nog steeds 2Publishers-installatie nodig hebben, een taakverdelingsmethode kunnen gebruiken. |  |
