...
| Adobe Search &amp; Promote | De integratie met Adobe Search &amp; Promote is afgekeurd. Adobe is niet van plan om verdere verbeteringen aan te brengen in de integratie van Zoeken en bevorderen. Integratie met Adobe Search &amp; Promote wordt nog steeds volledig ondersteund. |  |  |
...
| Forms | AEM Forms-integratie met AEM Mobile is afgekeurd. | Er is geen vervanging beschikbaar. |  | Ontwikkelaars | Klassieke UI Dialog Editor in CRXDE Lite. Adobe is niet van plan om de Klassieke Redacteur van de Dialoog UI verder te verbeteren die als deel van de distributie (QuickStart) wordt verscheept | Er is geen vervanging beschikbaar. |  |
