...
* &rbrack; De Auteurs van de Stichting &lbrack; kunnen sommige decimale waarden op het middeltype van het aantalgebied in een structuur van de componentendialoog voor aanraak gebruikersinterface (NPR-37059) niet ingaan.
...
* &rbrack; [!DNL Experience Manager] de beginpagina van de Stichting UI van het 0&rbrace; Platform verschijnt opnieuw wanneer de gebruiker het [!DNL Adobe Experience Manager] pictogram selecteert dat reeds op de beginpagina (CQ-4317409) is.&lbrack;
