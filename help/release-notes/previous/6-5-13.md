...
* Wanneer u een [!DNL Experience Manager] Workflow gebruikt om een e-mail in het Hebreeuws te verzenden, bevat het e-mailbericht dat aan het eind van de gebruiker wordt ontvangen vraagtekens (??) in plaats van tekst in het Hebreeuws (NPR-38296).
