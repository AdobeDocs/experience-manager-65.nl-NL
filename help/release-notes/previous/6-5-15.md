...
* Wanneer een Aanpassings Vorm veelvoudige panelen heeft en sommige panelen de uit-van-de-doos **component van de Bijlage van het 0} Dossier gebruiken, komt de** fout voor. `Error occurred while draft saving` (NPR-38978)
