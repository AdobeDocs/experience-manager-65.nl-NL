---
title: Nota's van de versie voor  [!DNL Adobe Experience Manager]  6.5.16.0
...
[!DNL Experience Manager] 6.5.16.0 omvat nieuwe eigenschappen, zeer belangrijke klant-gevraagde verhogingen, insectenmoeilijke situaties, en prestaties, stabiliteit, en veiligheidsverbeteringen die sinds de aanvankelijke beschikbaarheid van 6.5 in April 2019 worden vrijgegeven. [ installeer dit de dienstpak ](#install) op [!DNL Experience Manager] 6.5. <!-- UPDATE FOR EACH NEW RELEASE -->
...
* Wanneer een groot mediabestand (JPEG) naar Verzamelingen wordt geüpload, reageert de Experience Manager niet meer. (ASSETS-19387)
...
* De eigenschap `dam:size` wordt niet bijgewerkt na XMP terugschrijven, waardoor onjuiste informatie wordt geretourneerd van de `/platform/path/to/asset.jpg;resource=metadata` API. (ASSETS-17631)
* Niet-afgesloten resourceoplosser voor alle instanties van de Experience Manager. (ASSETS-16904)
...
* De Auteur van de Experience Manager daalt wegens een ladingskwestie, die de verwezenlijking van een synthetisch alarm ertoe aanzet. (ASSETS-15937)
* Op de pagina Dynamic Media General Settings wordt een onvertaald foutbericht `Failed to fetch data` weergegeven. (ASSETS-15617)
...
* Wanneer u een upgrade uitvoert naar AEM 6.5.14.0 en de service importData gebruikt om PDF samen te voegen met XML, treedt de volgende fout op: `Caused by: java.lang.NoSuchMethodError: com.adobe.xfa.form.FormModel.isXFABarcode(Lcom/adobe/xfa/Node;)Ljava/lang/Boolean` . (NPR-39807)
...
* Wanneer een gebruiker een adaptief formulier als een HTML weergeeft in de Microsoft® Edge-browser met IE-compatibiliteitsmodus, wordt het niet correct weergegeven. (CQ-4352216)
...
Na de installatie van het AEM 6.5.16.0 Forms add-on servicepakket kregen klanten te maken met de hieronder vermelde problemen. Zo, wordt een bijgewerkte versie van [ AEM 6.5.16.0 Forms toe:voegen-op de dienstpak - 6.0.914 ](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html) vrijgegeven. Adobe raadt u aan het bijgewerkte servicepack te gebruiken:
...
op com.adobe.aem.formsndocuments.servlet.ThemeClientLibraryDataSourceServlet.lambda$getThemeClientLibCategoryList$3(ThemeClientLibraryDataSourceServlet.java:76)
...
* Verwijder de code en de afhankelijkheid van de Search&amp;Promote van de Adobe uit Experience Manager 6.5. De Search&amp;Promote van de Adobe bereikte eind september 2022. Zie [ de Search&amp;Promote van de Adobe van de Eind-van-Dienst Aankondiging ](https://experienceleague.adobe.com/docs/discontinued/using/search-promote.html). (NPR-39706)
...
## [!DNL Experience Manager] 6.5.16.0 installeren {#install}

<!-- Remaining content from here to bottom stays the same except for version updating as needed as per update team feedback. -->

* [!DNL Experience Manager] 6.5.16.0 vereist [!DNL Experience Manager] 6.5. Zie [ verbeteringsdocumentatie ](/help/sites-deploying/upgrade.md) voor gedetailleerde instructies. <!-- UPDATE FOR EACH NEW RELEASE -->
...
De klanten die GraphQL gebruiken zouden het [ AEM van de Inhoud Fragment met het Pakket van de Index van GraphQL 1.0.5 ](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=%2Fcontent%2Fsoftware-distribution%2Fen%2Fdetails.html%2Fcontent%2Fdam%2Faem%2Fpublic%2Fadobe%2Fpackages%2Fcq650%2Ffeaturepack%2Fcfm-graphql-index-def-1.0.5.zip) moeten installeren.
...
* Wanneer een gebruiker AEM 6.5.16.0-servicepack installeert op JBoss® 7.1.4-platform, mislukt de implementatie van `adobe-livecycle-jboss.ear` .
...
* [ Lijst van Inhoudspakketten inbegrepen in Experience Manager 6.5.16.0 ](/help/release-notes/assets/65160_packages.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
