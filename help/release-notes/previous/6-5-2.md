...
* Als u [!DNL Dynamic Media] Cloud Services configureert in de modus [!DNL Dynamic Media] -Hybrid, worden meerdere lege rapportsuites gemaakt in [!DNL Analytics] en als er geen rapportsuite-id is opgeslagen in [!DNL Experience Manager] . Dit leidt tot duplicatie van rapportsuite. Hotfix voor CQ-4249780
* Het anders noemen van verrichting in [!DNL Experience Manager] activa aan gedupliceerde naam ontbreekt om aan Scene7 te synchroniseren. Hotfix voor CQ-4276763
...
* De optie Zoeken naar is niet beschikbaar voor TIFF-afbeeldingen. Hotfix voor CQ-4278238
...
* 3.8 SDK- en 5.13-viewers README-bestanden worden niet bijgewerkt en bevatten informatie uit eerdere releases. Hotfix voor CQ-4273737
...
* Bijgewerkte instantie van 6.3.3.2 tot 6.5 resulteert in dubbele OSGi-configuraties. NPR-30130: Hotfix voor CQ-4274016
...
* Als u in de modus Bladeren een HTML5-formulier leest met toegang tot niet-visuele desktops, leest de Chrome-browser &quot;grafisch&quot; vóór elke Scalable Vector Graphic (SVG) in het formulierontwerp. NPR-30449: Hotfix voor CQ-4274732
...
* Als de &quot;SubmitURL&quot; een en-teken (&amp;) bevat, worden parseringsfouten weergegeven in het logbestand wanneer een POST-aanvraag bij `renderpdf` servlet wordt ingediend. NPR-30865: Hotfix voor CQ-4278232
