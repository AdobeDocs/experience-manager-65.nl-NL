...
* Dynamic Media ondersteunt nu HEIC-afbeeldingsindeling zonder verlies voor Apple iOS/iPadOS. Zie [ fmt ](https://experienceleague.adobe.com/nl/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/http-protocol-reference/command-reference/r-is-http-fmt) in het Beeld van Dynamic Media die en API teruggeven.
...
* Wanneer Quick Publish van een inhoudsfragment wordt gebruikt, wordt het verder geladen en niet gepubliceerd. Met andere woorden, Quick Publish werkt niet voor Content Fragments na een servicepack-upgrade van AEM 6.5.7 naar AEM 6.5.17. Toen de gebruiker beheerde publicatie probeerde, werkte het. Toen ze echter Quick Publish probeerden, werd het niet gepubliceerd. `com.day.cq.wcm.core.impl.reference.ActivationReferenceSearchBuilder` heeft het systeem met name aan de prullenmand blootgesteld. (SITES-17311)
...
* Wanneer u CIF Core Components-pakket installeert op AEM, wijzigt u de `:type` -waarde van bestaande componenten. De wijziging betekent dat ze niet meer worden weergegeven op pagina&#39;s waaraan ze zijn toegevoegd. (SITES-17601)
...
* Wanneer een element wordt geüpload naar AEM, wordt de `Update_asset` -workflow geactiveerd. De workflow wordt echter nooit voltooid. De workflow wordt alleen voltooid tot de uploadprocedure voor het product. De volgende stap is de Scene7 batch upload, maar dat proces wordt niet in AEM gehaald. (ASSETS-30443)
* U hebt een betere manier nodig om niet-Dynamic Media video&#39;s netjes af te handelen in de Dynamic Media-component. Deze kwestie gaf een uitzondering die `dynamicmedia_sly.js` concretiseert. (ASSETS-31301)
...
* Wanneer een gebruiker een XDP maakt op AEM Forms Designer, wordt bij PDF-uitvoer de knopformuliertag niet genest in de bovenliggende alinealabel (p-tag). (LC-3921719)
...
* De `org.apache.sling.resourceMerger` bundel 1.4.2 werpt een uitzondering van AEM 6.5, Service Pack 17 en hoger. The Sling resource merge 1.4.4 should be included in Service Pack 20. (NPR-41630)
...
* Problemen met vertalingen van inhoudsfragmenten, waarbij de vertaalde tekenreeksen van de vertaalprovider worden teruggestuurd naar AEM, maar op het niveau van `/content/projects` blijven staan en de inhoudsfragmenten niet worden bijgewerkt. (NPR-41516)
...
## [!DNL Experience Manager] 6.5.20.0 installeren{#install}

<!-- Remaining content from here to bottom stays the same except for version updating as needed as per update team feedback. -->

* [!DNL Experience Manager] 6.5.20.0 vereist [!DNL Experience Manager] 6.5. Zie [ verbeteringsdocumentatie ](/help/sites-deploying/upgrade.md) voor gedetailleerde instructies. <!-- UPDATE FOR EACH NEW RELEASE -->
...
* Gebruikers kunnen geen correspondentiebeheerbrief maken. Wanneer een gebruiker een brief creeert, verschijnt een fout met beschrijving &quot;`Object Object`&quot;en de brief wordt niet gecreeerd. Miniaturen voor lay-outs kunnen ook niet worden geladen op het scherm voor het maken van letters. U kunt [ recentste AEM 6.5 Pak 20 van de Dienst van de Vorm (6.5.20.0) ](https://experienceleague.adobe.com/nl/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases) installeren om de kwestie op te lossen. (FORMS-13496)
* De interactieve communicatieservice maakt het PDF-document, maar de gegevens van de gebruiker worden niet automatisch ingevuld in de formuliervelden. De Prefill-service werkt niet zoals u had verwacht. U kunt [ recentste AEM 6.5 Pak 20 van de Dienst van de Vorm (6.5.20.0) ](https://experienceleague.adobe.com/nl/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases) installeren om de kwestie op te lossen. (FORMS-13413, FORMS-13493)
* De controle en Correct (RnC) redacteur van de dienst van de automatede form conversion kan niet laden. U kunt [ recentste AEM 6.5 Pak 20 van de Dienst van de Vorm (6.5.20.0) ](https://experienceleague.adobe.com/nl/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases) installeren om de kwestie op te lossen. (FORMS-13491)
* Na het bijwerken van AEM 6.5 Forms Service Pack 18 (6.5.18.0) of AEM 6.5 Forms Service Pack 19 (6.5.19.0) aan AEM 6.5 Forms Service Pack 20 (6.5.20.0), ontmoeten de gebruikers een fout van de JSP compilatie. Ze kunnen geen adaptieve formulieren openen of maken en fouten met andere AEM interfaces, zoals de pagina-editor, de AEM Forms-gebruikersinterface en de AEM Workfloweditor. U kunt [ recentste AEM 6.5 Pak 20 van de Dienst van de Vorm (6.5.20.0) ](https://experienceleague.adobe.com/nl/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases) installeren om de kwestie op te lossen. (FORMS-13492)
* In een adaptief formulier dat is gebaseerd op een XDP met ingesloten scripts in selectievakjes, worden de scripts niet uitgevoerd voor elementen na dergelijke selectievakjes. (FORMS-14244)
* Rijen in de datumkiezer-widget worden afgebroken tijdens het doorlopen van maanden in de pop-upwidget voor velden met het bewerkings-/weergavepatroon. (FORMS-13620)
* Formulierverzendingen mislukken wanneer wordt geprobeerd de DOR-service (Document of Record) op de achtergrond te gebruiken. Het foutbericht dat wordt aangetroffen, is: &quot;Handeling verzenden kan niet worden voltooid omdat de formulierbron niet correct is toegewezen.&quot; (FORMS-13798)
...
* [ Lijst van Inhoudspakketten inbegrepen in Experience Manager 6.5.20.0 ](/help/release-notes/assets/65200-packages.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
...
* [ de Steun van de Klant van de Adobe van het Contact ](https://experienceleague.adobe.com/nl/docs/customer-one/using/home).
