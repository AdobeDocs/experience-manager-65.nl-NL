...
UberJar voor [!DNL Experience Manager] 6.5.23.0 is beschikbaar in de [&#x200B; Gemaakt Centrale bewaarplaats &#x200B;](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.23/). <!-- CHECK FOR UPDATE EACH NEW RELEASE -->
...
* **FORMS-15256**: Wanneer de gebruikers van AEM 6.5 Forms Service Pack 18 of 19 aan Service Pack 20 of 21 bevorderden, ontmoetten zij een JSP compilatiefout. Door deze fout konden ze geen aangepaste formulieren openen of maken. Het veroorzaakte ook problemen met andere interfaces van AEM. Die interfaces omvatten de Redacteur van de Pagina, UI van AEM Forms, de redacteur van het Werkschema, en het Overzicht UI van het Systeem.
...
* **FORMS-16575**: Om het even welke wijzigingen in genestelde lay-outfragmenten&#39; XDP in een Interactieve Mededeling worden niet weerspiegeld in de redacteur IC.
...
* **FORMS-15681**:When de brief wordt bekeken in de Voorproef van de Druk, wordt de inhoud veranderd. Dat wil zeggen dat sommige spaties verdwijnen en dat bepaalde letters worden vervangen door `x` .
...
* **FORMS-21378**: Wanneer de server-zijBevestiging (SSV) wordt toegelaten, kan de vormvoorlegging ontbreken. Neem contact op met Adobe Support voor hulp als dit probleem zich voordoet.

* **FORMS-23881**: Op de plaatsingen van AEM Forms JEE opstelling die het 6.5.23.0 volledige installatieprogramma gebruiken, ontbreekt de Dienst van de Output om verzoeken te verwerken wanneer een douaneXCI dossier in de aanroeping wordt geleverd. Om deze kwestie op te lossen, installeer het recentste Pak van de Dienst van AEM 6.5.24.0 Forms van het [&#x200B; portaal van de Distributie van de Software &#x200B;](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html).
...
* [Lijst met OSGi-bundels in Experience Manager 6.5.23.0](/help/release-notes/assets/65230-bundles.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Lijst met inhoudspakketten in Experience Manager 6.5.23.0](/help/release-notes/assets/65230-packages.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
