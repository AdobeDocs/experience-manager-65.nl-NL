...
* Wanneer u de component Drag hier optie in ontvankelijke placeholder van het net selecteert, wordt een verzoek van de GET verzonden en het verzoek resulteert in fout HTTP 403 (NPR-31845).
...
* Kan de campagne niet synchroniseren in een Adobe-campagne met de ontwerpimportcomponent OOTB (Out of the box) (NPR-31728).
