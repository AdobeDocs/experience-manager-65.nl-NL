...
* Wanneer een pagina met bepaalde fragmenten van de Ervaring op niet redacteurswijze (of in Auteur zonder wordt geopend `editor.html` voorvoegsel en `wcmmode=disabled`, of in Publisher), eindigt de aanvraag in HTTP-statusfoutcode 500 (NPR-30743).
