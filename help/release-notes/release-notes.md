...
#### Integraties{#foundation-integrations-6524}
...
* Oplossing voor een onverwachte JSP-compilatiefout met de `org.apache.sling.scripting.jsp:2.6.0` -bundel. (SLING-12442)
...
AEM 6.5 LTS SP2 biedt moderne OpenAPI&#39;s voor Content Fragment en Model Management, zodat de oudere eindpunten voor ondersteuning van inhoudsfragmenten in de AEM Assets REST API nu afgekeurd zijn.

Adobe is van plan om deze oudere eindpunten beschikbaar te houden tot een einde van de levensduur. Adobe is niet van plan verdere verbeteringen toe te passen op de afgekeurde eindpunten.
...
* **FORMS-23881** op de plaatsingen van AEM Forms JEE opstelling gebruikend het 6.5.23.0 volledige installatieprogramma, ontbreekt de Dienst van de Output om verzoeken te verwerken wanneer een douaneXCI dossier in de aanroeping wordt geleverd. Om deze kwestie op te lossen, installeer het recentste Pak van de Dienst van AEM 6.5.24.0 Forms van het [&#x200B; portaal van de Distributie van de Software &#x200B;](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html).
...
* **FORMS-15256** toen de gebruikers van AEM 6.5 Forms Service Pack 18 of 19 aan Service Pack 20 of 21 bevorderden, ontmoetten zij een JSP compilatiefout. Door deze fout konden ze geen aangepaste formulieren openen of maken. Het veroorzaakte ook problemen met andere interfaces van AEM. Die interfaces omvatten de Redacteur van de Pagina, UI van AEM Forms, de redacteur van het Werkschema, en het Overzicht UI van het Systeem.
...
* [Lijst met OSGi-bundels in Experience Manager 6.5.24.0](/help/release-notes/assets/65240-bundles.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Lijst met inhoudspakketten in Experience Manager 6.5.24.0](/help/release-notes/assets/65240-packages.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
...
* [&#x200B; de Klantenondersteuning van Adobe van het Contact &#x200B;](https://experienceleague.adobe.com/nl/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#).
