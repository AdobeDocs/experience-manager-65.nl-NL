...
AEM 6.5.21, 6.5.22, 6.5.23 en AEM 6.5 LTS GA bevatten de `org.apache.sling.scripting.jsp:2.6.0` -bundel, die wordt beïnvloed door een bekend probleem. Dit probleem wordt meestal gezien bij hoge laadvoorwaarden wanneer veel gelijktijdige aanvragen worden verwerkt door het AEM-exemplaar.
