...
* In AEM Forms 6.5.23.0 met Hotfix 2, (PDFG) PS naar PDF en HTML naar PDF (WebKit) omzettingsfout. (FORMS-21721)

* In AEM Forms 6.5.23.0 met Hotfix 3 mislukt de conversie van (PDFG) Image naar PDF. (FORMS-2029)
