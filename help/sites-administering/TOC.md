...
audience: admin-user
user-guide-title: AEM 6.5 Beheerdershandleiding
...
# AEM 6.5 Beheerdershandleiding {#administering}
...
+ Sitefuncties {#introduction}
   ...
   + [Inhoud opnieuw gebruiken: Sitebeheer en Live kopiëren](msm.md)
   ...
   + [Het Kader voor de Integratie van de Vertaling vormen](tc-tic.md)
   + [Wizard Taalkopie](tc-wizard.md)
   + [Verbeteringen op gebied van vertaling](tc-enhancements.md)
...
+ Bewerkingen {#operations}
   ...
   + [AEM voor probleemoplossing](troubleshoot.md)
   ...
   + [Container en lay-outmodus configureren](configuring-responsive-layout.md)
...
+ Integratie {#integration}
   ...
   + [Integreren met Adobe Learning Manager](adobe-learningmanager.md)
