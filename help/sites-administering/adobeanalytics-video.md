...
>[!NOTE]
>
>Voordat u verdergaat, moet u ervoor zorgen dat er een **afspeelbare video** is geüpload in AEM.
>
>Als u wilt dat uw video&#39;s op de pagina worden afgespeeld, raadpleegt u **[deze zelfstudie](/help/sites-authoring/default-components-foundation.md#video)** voor informatie over het transcoderen van videobestanden in AEM.

Gebruik de volgende procedure om een framework voor het bijhouden van video&#39;s in te stellen met elke methode.

>[!NOTE]
>
>Voor nieuwe implementaties, adviseert men dat u **niet** de erfenisopties voor video het volgen gebruikt. Gebruik in plaats hiervan de methode **Mijlpalen**.

## Algemene stappen {#common-steps}

1. Een webpagina instellen door een **video-component** van het hulpwerkstation te slepen en een afspeelbare **video als element** voor de component toe te voegen

1. [Maak een Adobe Analytics-configuratie en -framework](/help/sites-administering/adobeanalytics.md).

   * De voorbeelden in de volgende secties gebruiken de naam **my-sc-configuration** voor de configuratie en **video** voor het framework.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Verzonden telkens als een mijlpaal wordt teweeggebracht, wordt het aantal seconden de gebruiker besteedde het letten op het bepaalde segment ook verzonden samen met deze gebeurtenis. bijv. eventX=21<br /> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>Wordt verzonden wanneer de opgegeven mijlpaal is bereikt, dan staat X voor de seconde dat de mijlpaal wordt geactiveerd bij<br /> </td>
  </tr>
  <tr>
...
>[!NOTE]
>
>U kunt de **gebruikersvriendelijke** naam van een video plaatsen door de video voor het uitgeven in DAM te openen, en **Titel** meta-gegevensgebied aan de gewenste naam te plaatsen.
...
1. Als u de CQ-variabelen wilt toewijzen aan Adobe Analytics-eigenschappen, sleept u de Adobe Analytics-eigenschappen van ContentFinder naast de CQ-variabele op de component.
   ...
   Zie de handleiding [Video meten in Adobe Analytics](https://docs.adobe.com/content/help/en/media-analytics/using/media-overview.html) voor informatie over het optimaliseren van de toewijzingen.

1. [Voeg het ](/help/sites-administering/adobeanalytics.md) framework toe aan de pagina.
1. Als u de installatie wilt testen in **Voorvertoningsmodus**, speelt u de video af om Adobe Analytics-aanroepen te activeren.
...
*Dit is de **eerste**aanroep van Adobe Analytics met de volgende waarden:*
...
Deze methode is vergelijkbaar met de methode met mijlpalen, waarbij het verschil is dat de mijlpalen die in het veld *Offset bijhouden* zijn opgegeven percentages zijn in plaats van instelpunten in de video.
...
<table>
 <tbody>
  <tr>
   ...
   <td>Variabelen die hieraan zijn toegewezen, bevatten de <strong>gebruiksvriendelijke</strong>-naam (<strong>Title</strong>) van de video indien deze in de DAM is ingesteld; als de titel niet is ingesteld, wordt in plaats daarvan de <strong>bestandsnaam</strong> van de video verzonden. Slechts één keer verzonden, aan het begin van het spelen van een video.<br /> </td>
  </tr>
  <tr>
   <td>eventdata.videoFileName </td>
...
>[!NOTE]
>
>U kunt de **gebruikersvriendelijke** naam van een video plaatsen door de video voor het uitgeven in DAM te openen, en **Titel** meta-gegevensgebied aan de gewenste naam te plaatsen. U moet ook de aangebrachte wijzigingen opslaan wanneer u klaar bent.

1. Deze variabelen toewijzen aan de profielen 1 tot en met 3

   De **rest van de relevante informatie** in de vraag zal in **one** variabele worden samengevoegd genoemd **pev3**.

   **Voorbeelden van** aanroepen naar Adobe Analytics met behulp van het opgegeven voorbeeld moeten er als volgt uitzien bij weergave met DigitalPulse-foutopsporing:
...
1. Deze variabelen toewijzen aan prop1, prop2 en prop3
   ...
   De **rest van de relevante informatie** in de vraag zal in **one** variabele genoemd **pev3** worden samengevoegd.

   De vraag aan Adobe Analytics die het verstrekte voorbeeld gebruikt zou als dit moeten kijken wanneer bekeken met Debugger DigitalPulse:

   ![lseconds](assets/lseconds.png)

   *De vraag is gelijkaardig aan de Verouderde vraag van de Mijlpalen hierboven. Zie de informatie over pev3 **[die daar wordt verstrekt](/help/sites-administering/adobeanalytics.md)**.*
