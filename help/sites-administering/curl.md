...
1. Kopieer de opdracht cURL naar een teksteditor en verwijder alle koppen uit de opdracht, die beginnen met `-H` (blauw gemarkeerd in de onderstaande afbeelding) en voeg de juiste verificatieparameter toe, zoals `-u admin:admin`.
