...
Om de plaatsingshaak te gebruiken, moet Dynamische Tag Management met de AEM instantie kunnen verbinden die de bibliotheken ontvangt. [&#x200B; laat toegang tot AEM &#x200B;](/help/sites-administering/dtm.md#enabling-access-for-the-deployment-hook-service) voor de Dynamische servers van Tag Management toe.
