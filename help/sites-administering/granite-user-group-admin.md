...
Als u **Gebruikers** of **groepen** kiest in de console Tools, wordt de juiste console geopend. In beide gevallen kunt u actie ondernemen met het selectievakje en vervolgens met handelingen vanaf de werkbalk, of door de accountgegevens te openen via de koppeling onder **Naam**.

* [Gebruikersbeheer](#user-administration)

   ![chlimage_1-73](assets/chlimage_1-73a.png)

   De **gebruikersconsolelijsten** :
...
1. Het formulier **Gebruiker** maken wordt geopend:
   ...
   * **Gebruiker toevoegen aan groepen**
      ...
      Gebruik het keuzemenu Selectie om groepen te selecteren waarvan de gebruiker lid zou moeten zijn. Als deze optie is geselecteerd, schakelt u de **X** met de naam uit voordat u het bestand opslaat.

   * **Groepen**

      Een lijst met groepen waarvan de gebruiker momenteel lid is. Gebruik de **X** bij de naam om de selectie op te heffen voordat u het bestand opslaat.


1. Wanneer u het gebruik van de gebruikersaccount hebt gedefinieerd:

   * **Annuleren** om de registratie af te breken.
   * **Sla** op om de registratie te voltooien. Het maken van de gebruikersaccount wordt bevestigd met een bericht.
...
1. U kunt de gegevens nu op dezelfde manier bewerken als in [Een nieuwe gebruiker](#adding-a-new-user)toevoegen.
...
1. U kunt de gegevens nu op dezelfde manier bewerken als in [Een nieuwe gebruiker](#adding-a-new-user)toevoegen. Onder **Accountinstellingen** vindt u een koppeling voor het **wijzigen van het wachtwoord**.
...
1. Gebruik het klikvakje om één of meerdere gebruikers te markeren.
1. Gebruik het pictogram **Verwijderen** om de gebruikersgegevens te verwijderen:
...
1. Het formulier Groep **** maken wordt geopend:
   ...
   * **Leden aan groep toevoegen**
      ...
      Gebruik de keuzelijst Selectie om gebruiker(s) te selecteren die u aan de groep wilt toevoegen. Als deze optie is geselecteerd, schakelt u de **X** met de naam uit voordat u het bestand opslaat.

   * **Groepsleden**

      Een lijst met gebruikers in de groep. Gebruik de **X** bij de naam om de selectie op te heffen voordat u het bestand opslaat.

1. Wanneer u de groep hebt gedefinieerd, gebruikt u:

   * **Annuleren** om de registratie af te breken.
   * **Sla** op om de registratie te voltooien. De oprichting van de groep wordt bevestigd met een bericht.
...
1. U kunt de details nu bewerken en opslaan zoals in [Een nieuwe groep](#adding-a-new-group)toevoegen.
...
1. Het formulier Groepsinstellingen **** bewerken wordt geopend.
   ...
   U kunt de details nu bewerken en opslaan zoals in [Een nieuwe groep](#adding-a-new-group)toevoegen.

### Een bestaande groep verwijderen {#deleting-an-existing-group}

1. Gebruik het klikvakje om één of meerdere groepen te markeren.
1. Gebruik het pictogram **Verwijderen** om de groepdetails te verwijderen:
