...
Door gebrek, voert de agent een controle van de lijst van gewezen personen tegen huidige bekende kwetsbare klassen uit. Deze lijst van gewezen personen is bedoeld om u tegen de huidige lijst van exploitaties te beschermen die dit type van kwetsbaarheid gebruiken.
...
Adobe biedt officieel ondersteuning voor Java™ 6, 7 en 8. Adobe begrijpt echter ook dat NotSo Serial Java™ 5 ondersteunt.
...
De standaardinstelling van **class-name-only** Hiermee wordt u geïnformeerd over de klassen die worden gedeserialiseerd.
