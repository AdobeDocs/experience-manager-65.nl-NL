...
1. In de [navigatievenster,](/help/sites-authoring/basic-handling.md#first-steps) klikken of tikken **Gereedschappen** -> **Cloud Servicen** -> **Cloud Servicen voor vertaling**.
...
1. In de [navigatievenster,](/help/sites-authoring/basic-handling.md#first-steps) tikken of klikken **Gereedschappen** -> **Cloud Servicen** -> **Cloud Servicen voor vertaling**.
