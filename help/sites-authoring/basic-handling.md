...
![Algemene navigatie](assets/bh-03.png)
...
<table>
 <tbody>
  ...
  <tr>
   <td>Activa<br /> </td>
   <td>Met deze consoles kunt u importeren en <a href="/help/assets/assets.md">digitale middelen beheren</a> zoals afbeeldingen, video's, documenten en audiobestanden. Deze elementen kunnen vervolgens worden gebruikt door elke website die op hetzelfde AEM wordt uitgevoerd. </td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Forms</td>
   <td>Met deze console kunt u uw <a href="/help/forms/using/introduction-aem-forms.md">formulieren en documenten</a>.</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Sites</td>
   <td>Met de siteconsoles kunt u <a href="/help/sites-authoring/page-authoring.md">websites maken, weergeven en beheren</a> uitvoeren op uw AEM. Via deze consoles kunt u websitepagina's maken, bewerken, kopiëren, verplaatsen en verwijderen, workflows starten en pagina's publiceren.<br /> </td>
  </tr>
 </tbody>
</table>
...
* [Gebruikerseigenschappen](/help/sites-authoring/user-properties.md)
  ...
  ![Gebruikerseigenschappen](do-not-localize/screen_shot_2018-03-23at103603.png)
...
* [Spoorwegkiezer](/help/sites-authoring/basic-handling.md#rail-selector)
  ...
  ![Spoorwegkiezer](assets/screen_shot_2018-03-23at104029.png)
...
* **Maken** knop
  ...
  ![Maken](assets/screen_shot_2018-03-23at104301.png)
...
* **Pagina-editor**
  ...
  ![Pagina-editor](assets/bh-11.png)
...
* [Snelle acties](#quick-actions) zijn ook beschikbaar in deze weergave, zoals selectie en algemene handelingen zoals bewerken.
  ...
  ![Kaartweergave - Snelle handelingen](assets/bh-13-1.png)
...
* Als u alle items in de lijst gemakkelijk wilt selecteren, gebruikt u het selectievakje linksboven in de lijst.
  ...
  ![Lijstweergave - Alles selecteren](assets/bh-20.png)
...
![Spoorwegkiezer](assets/bh-25.png)
