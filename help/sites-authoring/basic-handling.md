...
seo-description: Geniet van gemak bij het navigeren AEM en het basisgebruik ervan
...
>[!NOTE]
>
>Voor een goed inzicht in het basisgebruik van AEM is dit document gebaseerd op de console **Sites**.
>
...
Klik of tik **Volgende** om naar de volgende pagina van het overzicht te gaan. Klik of tik **Close** of klik of tik buiten het overzichtsdialoogvenster om te sluiten.

Het overzicht zal de volgende keer opnieuw beginnen u tot een console toegang hebt tenzij u of alle dia&#39;s bekijkt, of de optie **toon dit niet opnieuw**.
...
* **[Navigation](/help/sites-authoring/basic-handling.md#navigation-panel)**  - Vertegenwoordigd door een kompas
* **[Gereedschappen](/help/sites-authoring/basic-handling.md#tools-panel)**  - voorgesteld door een hamer
...
<table>
 <tbody>
  ...
  <tr>
   <td>Assets<br /> </td>
   <td>Met deze consoles kunt u digitale elementen, zoals afbeeldingen, video's, documenten en audiobestanden, importeren en <a href="/help/assets/home.md">beheren. </a> Deze elementen kunnen vervolgens worden gebruikt door elke website die op hetzelfde AEM wordt uitgevoerd. </td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Forms</td>
   <td>Met deze console kunt u uw <a href="/help/forms/home.md">formulieren en documenten</a> maken, beheren en verwerken.</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>Schermen</td>
   <td><a href="https://docs.adobe.com/content/help/en/experience-manager-screens/user-guide/authoring/setting-up-projects/creating-a-screens-project.html">Met </a> schermbeveiliging kunt u al uw klantgerichte schermen, van elke grootte en op elke locatie beheren.</td>
  </tr>
  <tr>
   <td>Sites</td>
   <td>Met de Sites-consoles kunt u <a href="/help/sites-authoring/page-authoring.md">websites maken, weergeven en beheren</a> die op uw AEM-instantie worden uitgevoerd. Via deze consoles kunt u websitepagina's maken, bewerken, kopiëren, verplaatsen en verwijderen, workflows starten en pagina's publiceren.<br /> </td>
  </tr>
 </tbody>
</table>
...
* [Weergaven](/help/sites-authoring/basic-handling.md#viewingandselectingyourresourcescardlistcolumn)
   ...
   Het weergavepictogram bevindt zich helemaal rechts van de AEM werkbalk. De huidige weergave wordt ook gewijzigd. In de standaardweergave wordt bijvoorbeeld **Kolomweergave** weergegeven:
...
* Toetsenbordnavigatie
   ...
   In de **Sites** console is er de toegevoegde optie aan **Overslaan aan hoofdinhoud**. Dit wordt zichtbaar aangezien u *tab* door de kopbalopties, en versnelt uw navigatie door u toe te staan om de standaardelementen in de (product) toolbar over te slaan en u rechtstreeks aan de belangrijkste inhoud te nemen.
...
* De huidige console.
* De huidige context.
* Of u zich in [selectiemodus](#navigatingandselectionmode) bevindt.
...
In [Kaartweergave](#cardviewquickactions) zijn bepaalde handelingen beschikbaar als snelactiepictogrammen en bevinden deze zich op de werkbalk. Er zijn snelactiepictogrammen beschikbaar voor één item tegelijk, zodat u geen voorselectie hoeft te maken.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>Desktop:<br /> MouseOver, dan gebruik het controleteken snelle actie</li>
     <li>Mobiel apparaat:<br /> Tik en houd de kaart vast</li>
    </ul> </td>
   <td>
    <ul>
...
* In **Kolomweergave** worden alle items in de meest linkse kolom geselecteerd.
...
* klikken of tikken op de **X** naast de telling,
...
1. Nadat u een bron hebt geselecteerd, wordt de bovenste koptekst bedekt door de werkbalk [Handelingen](#actionstoolbar) die toegang biedt tot handelingen die momenteel van toepassing zijn op de geselecteerde bron.

   Als u de selectiemodus wilt afsluiten, selecteert u **X** rechtsboven of gebruikt u **escape**.
...
* Selecteer de kolommen die moeten worden weergegeven met de optie **Instellingen weergeven** onder de knop Weergaven. De volgende kolommen zijn beschikbaar voor weergave:
...
* U kunt de Gegevens van de Analyse tonen door de aangewezen kolommen te tonen gebruikend **de Montages van de Mening** dialoog.
...
* [Verschillende ](#timelineviewevents) gebeurtenissen met betrekking tot een geselecteerd item weergeven.
...
* Specifieke consoles hebben extra functionaliteit. In de Sites-console kunt u bijvoorbeeld:
   ...
   * [Sla een versie](/help/sites-authoring/working-with-page-versions.md#creatinganewversiontouchoptimizedui) op.
   * [Start een workflow](/help/sites-authoring/workflows-applying.md#startingaworkflowfromtherail).
...
**Met** verwijzingen worden verbindingen met de geselecteerde bron weergegeven. In de **Sites**-console [references](/help/sites-authoring/author-environment-tools.md#showingpagereferences) voor pagina&#39;s ziet u bijvoorbeeld:
