...
1. Sleep componenten rechtstreeks naar de pagina en bewerk ze dienovereenkomstig. Bijvoorbeeld, kunt u a **Tekst &amp; Personalization (Campagne)** component slepen en gepersonaliseerde tekst toevoegen.
   ...
   Zie {de Componenten van 0} Adobe Campaign [ voor een gedetailleerde beschrijving van elke component.](/help/sites-authoring/adobe-campaign-components.md)
...
Zie {de Componenten van 0} Adobe Campaign [ voor een volledige beschrijving van de componenten van de Campagne.](/help/sites-authoring/adobe-campaign-components.md)
...
1. Open de component door op het potloodpictogram te klikken. De editor Inplace wordt geopend.
   ...
   >
   >* De beschikbare contextgebieden worden dynamisch teruggekregen van het schema van Adobe Campaign **nms:seedMember**. De gegevens van de doelextensie worden dynamisch hersteld vanuit de workflow die de levering bevat die met de inhoud is gesynchroniseerd. (Zie [ Synchronizing inhoud die in AEM met een levering van Adobe Campaign ](#synchronizing-content-created-in-aem-with-a-delivery-from-adobe-campaign-classic) wordt gecreeerd sectie).
   >
