...
De activiteiten en ervaringen die u op de wijze van het Doel ziet wijzen op [Activites console](/help/sites-authoring/activitylib.md):
...
Wanneer u een activiteit toevoegt, verschijnt het ook in [Activiteitenconsole](/help/sites-authoring/activitylib.md).
...
1. Gebruik het vervolgkeuzemenu **Merk** om het merk te selecteren waarvoor u de activiteit wilt maken.
   ...
   >[!NOTE]
   >
   >Het wordt geadviseerd om [merken door de activiteitenconsole te creëren](/help/sites-authoring/activitylib.md#creating-a-brand-using-the-activities-console).
   >
   >
...
1. Selecteer in het vervolgkeuzemenu **Doelengine** de doelengine.
   ...
   * Als u **Adobe Target** selecteert, kunt u een configuratie (door gebrek, is het de configuratie u verstrekte toen u [de rekening ](/help/sites-administering/opt-in.md)) en het Type van Activiteit vormde.

   * Als u de integratie AEM/Adobe Campaign gebruikt en gerichte inhoud (nieuwsbrieven) verzendt, uitgezocht **Adobe Campaign**. Zie [Integreren met Adobe Campaign](/help/sites-administering/campaign.md) voor meer informatie.
...
Aanbiedingen die [op pagina](/help/sites-authoring/content-targeting-touch.md#adding-a-custom-offer) worden ontworpen en voor één enkele ervaring worden gebruikt worden genoemd douaneaanbiedingen. De volgende afbeelding wordt over de inhoud van een aangepaste aanbieding heen geplaatst:

![chlimage_1-15](assets/chlimage_1-15.png)

Aanbiedingen die worden [toegevoegd uit een aanbiedingsbibliotheek](/help/sites-authoring/content-targeting-touch.md#adding-an-offer-from-an-offer-library), worden overschreven door de volgende afbeelding:
...
1. Klik of tik op het pictogram Doel.
   ...
   De inhoud van de component is de aanbieding voor de Standaardervaring. Wanneer een component wordt gericht, zal zijn standaardknoop voor elke ervaring worden herhaald. Dit is nodig voor het bewerken van het juiste inhoudsknooppunt tijdens specifieke ontwerphandelingen. Voor deze niet-standaard ervaringen, of [voeg een douaneaanbieding ](/help/sites-authoring/content-targeting-touch.md#adding-a-custom-offer) of [voeg een bibliotheekaanbieding](/help/sites-authoring/content-targeting-touch.md#adding-an-offer-from-an-offer-library) toe.
...
>[!NOTE]
>
>Aanbiedingen die u met de [console van Aanbiedingen](/help/sites-authoring/offerlib.md) creeert kunnen verscheidene componenten ook bevatten. Deze aanbiedingen horen bij een aanbiedingsbibliotheek en kunnen voor meerdere ervaringen worden gebruikt.
...
1. Maak het voorstel:
   ...
   * Voor niet-standaard ervaringen, of [voeg een douaneaanbieding ](#adding-a-custom-offer) of [voeg een bibliotheekaanbieding](/help/sites-authoring/content-targeting-touch.md#adding-an-offer-from-an-offer-library) toe.
...
Als u besluit dat de aanbieding voor andere ervaringen kan worden gebruikt, kunt u een douaneaanbieding tot stand brengen en [toevoegen het aan bibliotheek](/help/sites-authoring/content-targeting-touch.md#adding-a-custom-offer-to-a-library). Voor informatie over het gebruiken van de console van Aanbiedingen om een herbruikbare aanbieding tot stand te brengen, zie [een Aanbieding aan een Bibliotheek van de Aanbieding toevoegen](/help/sites-authoring/offerlib.md#add-an-offer-to-an-offer-library).
...
Voeg een aanbieding van [aanbiedingsbibliotheek](/help/sites-authoring/offerlib.md) aan een ervaring toe. U kunt elke aanbieding toevoegen uit de bibliotheek van het merk waarvoor u momenteel kiest.
...
Voeg een douaneaanbieding aan [aanbiedingsbibliotheek](/help/sites-authoring/offerlib.md) toe wanneer u het als aanbieding voor veelvoudige ervaringen wilt hergebruiken. U kunt aanbiedingen toevoegen aan de bibliotheek van het huidige merk waarop u zich richt.

Voor informatie over het gebruiken van de console van Aanbiedingen om een herbruikbare aanbieding tot stand te brengen, zie [een Aanbieding aan een Bibliotheek van de Aanbieding toevoegen](/help/sites-authoring/offerlib.md#add-an-offer-to-an-offer-library).
...
Zie [Richtende motor](/help/sites-authoring/personalization.md#targeting-engine) voor informatie over motoren.
...
Bij de stap Doelstellingen en instellingen van [het doelproces](/help/sites-authoring/content-targeting-touch.md#the-targeting-process-create-target-and-goals-settings) wordt het gedrag van de merkactiviteit geconfigureerd. Geef op wanneer de activiteit begint en eindigt en geef ook de prioriteit van de activiteit op. Bovendien volgt u ook doelstellingen. Specifiek kunt u beslissen wat u met uw activiteiten wilt meten.
 ...
 <tbody>
  <tr>
   ...
   <td><p>Het percentage bezoekers dat heeft geklikt op een onderdeel van de ervaring die wordt getest. Een conversie kan één keer per bezoeker worden geteld of telkens wanneer een bezoeker een conversie voltooit. De omzettingsmetrische waarde wordt geplaatst aan één van het volgende:</p>
    <ul>
     <li><strong>Een pagina</strong>  is weergegeven. U kunt definiëren welke pagina door een  <strong>URL </strong> te selecteren en vervolgens de URL of meerdere URL's te definiëren, of door  <strong>URL-</strong> containers te selecteren en vervolgens een pad of trefwoord toe te voegen.</li>
     <li><strong>Een box</strong>  weergegeven - U kunt opgeven welke box uw publiek heeft weergegeven door de naam van de mbox in te voeren. U kunt veelvoudige dozen ingaan door <strong>Add een Mbox</strong> te klikken.</li>
    </ul> </td>
  </tr>
  <tr>
...
1. Als u een prioriteit voor de activiteit wilt opgeven, gebruikt u de schuifregelaar om **Laag**, **Normaal** of **Hoog** te selecteren.
1. Als u Adobe Analytics met uw Rekening van Adobe Target hebt gevormd, dan ziet u **Rapporterende Bron** drop-down menu. Selecteer **Adobe Target** of **Adobe Analytics** als bron.
...
Na het vormen, kunt u [de prestaties van uw activiteiten bekijken](/help/sites-authoring/activitylib.md#viewing-performance-and-converting-winning-experiences-a-b-test) die Adobe Target (of ervaring of A/B test het richten) gebruiken. Bovendien kunt u met A/B test het richten, de winnaars [omzetten.](/help/sites-authoring/activitylib.md#viewing-performance-and-converting-winning-experiences-a-b-test)
...
* De [Activiteiten die op](/help/sites-authoring/activitylib.md) zijn.
...
* De [configuratie van de richtende motor](/help/sites-authoring/activitylib.md).
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Selecteer tussen <strong>Client side Rules (zonder tracking), Adobe Target, ContextHub, </strong>en<strong> Adobe Campaign </strong>afhankelijk van welke engine u wilt gebruiken.</td>
  </tr>
 </tbody>
</table>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>Wanneer u nauwkeurige adressering inschakelt, weet de component dat deze moet wachten totdat de context- of contexthubgegevens beschikbaar zijn voordat de aanvraag naar Adobe Target wordt verzonden. Hierdoor kan de laadtijd toenemen. Voor creatie, wordt het nauwkeurige richten altijd toegelaten.</p> <p>Als u <strong>Nauwkeurige het richten </strong> controledoos selecteert, voert mbox eerst <code>mboxDefine</code> en <code>mboxUpdate</code> later resulterend in een Ajax- verzoek uit zodra de gegevens beschikbaar zijn.</p> <p>Als u niet <strong>Nauwkeurige het richten </strong> controledoos selecteert, voert mbox <code>mboxCreate</code> onmiddellijk resulterend in een synchrone aanvraag uit (in dit geval, kunnen niet alle contextgegevens nog beschikbaar zijn).</p> <p><strong>Opmerking:</strong> Het inschakelen of uitschakelen van nauwkeurige activering voor een specifieke component heeft geen invloed op de instellingen die u globaal hebt ingesteld. U kunt globale instellingen altijd overschrijven door Accurate doelen selecteren in de component.</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>Klik of tik <strong>Voeg gebied</strong> toe om extra contextparameters (het zelfde als wat in het kader van het Doel beschikbaar is) te vormen. Contextparameters die aan de component worden toegevoegd, passen <i>alleen</i> op de component toe en niet op andere component, zoals het geval zou zijn als u contextparameters rechtstreeks aan het framework toevoegt.</td>
  </tr>
  <tr>
   <td><strong>Statische parameters</strong></td>
   <td>Klik of tik <strong>Voeg gebied</strong> toe om extra statische parameters (het zelfde als wat in het kader van het Doel beschikbaar is) te vormen. Statische parameters die aan de component worden toegevoegd, passen <i>alleen</i> op de component en niet op andere component toe zoals het geval zou zijn als u statische parameters rechtstreeks aan het framework toevoegt. Statische parameters komen niet uit context (cliëntcontext van inhoudshub).</td>
  </tr>
 </tbody>
</table>
