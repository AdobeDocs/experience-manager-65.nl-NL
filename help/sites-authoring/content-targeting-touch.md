...
1. Gebruik het **Merk** drop-down menu om het merk te selecteren waarvoor u de activiteit wilt tot stand brengen.
   ...
   >[!NOTE]
   >
   >De Adobe adviseert dat u [ brands door de activiteitenconsole ](/help/sites-authoring/activitylib.md#creating-a-brand-using-the-activities-console) creeert.
   >
   >
...
1. In het **richten** motor drop-down menu, selecteer uw het richten motor.
   ...
   * Als u **AEM ContextHub** selecteert, worden de resterende gebieden gedimd en niet beschikbaar. Klik **creëren**.
...
1. Om een prioriteit voor de activiteit te specificeren, gebruik de schuif om of **Laag**, **Normaal**, of **Hoog** te selecteren.
1. Als u de Analyse van de Adobe met uw Rekening van Adobe Target hebt gevormd, dan ziet u **Meldend Source** drop-down menu. Selecteer **Adobe Target** of **Adobe Analytics** als bron.
...
U selecteert **Adobe Campaign** als motor als u AEM met Adobe Campaign integreert. Zie [ Integrerend AEM met Adobe Campaign ](/help/sites-administering/campaign.md) voor meer informatie.
