...
>[!NOTE]
>
>Sommige uit-van-de-doos Componenten van de Kern, zoals **[Carrousel &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/carousel.html?lang=nl-NL)** verstrekken geen **Alternatieve 4&rbrace; gebied van de Tekst om afwisselende tekstbeschrijvingen aan individuele beelden toe te voegen, hoewel er het** 6&rbrace; gebied van het Etiket **(** **[lusje van de Toegankelijkheid) voor de volledige component is.](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/wcm-components/carousel.html?lang=nl-NL#accessibility-tab)**
>
...
* Niveau AA
* Contrast (Minimum): De visuele presentatie van tekst en beelden van tekst heeft een contrastverhouding van minstens 4.5 :1, behalve het volgende:
   * Grote tekst: tekst op grote schaal en afbeeldingen van tekst op grote schaal hebben een contrastverhouding van ten minste 3 :1 .
...
* Voor tekst met een grootte kleiner dan 18 punten (of 14 punten vet), moet de contrastverhouding tussen tekst/afbeeldingen van tekst en de achtergrond ten minste 4,5 zijn :1.
* Voor tekst die minstens 18 punt (of 14 punt vette) in grootte is, zou de contrastverhouding minstens 3 :1 moeten zijn.
* Als een achtergrond wordt geëtiketteerd, dan zou de achtergrond rond om het even welke tekst moeten worden gearceerd zodat 4.5 :1 of 3 :1 verhouding wordt gehandhaafd.
