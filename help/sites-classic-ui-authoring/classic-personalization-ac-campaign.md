...
1. Selecteer **Pagina** tabblad in het zijpaneel en selecteer vervolgens **Pagina-eigenschappen.**
1. In de **Cloudservices** in het pop-upvenster selecteert u **Service toevoegen** om de Adobe Campaign-service toe te voegen en klik op **OK**.
...
1. Selecteer in de vervolgkeuzelijst de configuratie die overeenkomt met uw Adobe Campaign-instantie en klik vervolgens op **OK**.
   ...
   >[!NOTE]
   >
   >Tik of klik op **OK** of **Toepassen** na het toevoegen van de cloudservice. Hierdoor wordt de **Adobe Campaign** gebruiken.
