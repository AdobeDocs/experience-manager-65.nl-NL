...
1. Als AEM al is geconfigureerd voor de Tar- of MongoDB-opslag, verwijdert u bestaande configuratiebestanden uit de ***&lt;aem-install>**/*crx-quickstart*/*install*-map procedure. De bestanden die moeten worden verwijderd, zijn:
...
AEM kan worden geconfigureerd om gegevens op te slaan in de Azure Storage Service van Microsoft®. De `org.apache.jackrabbit.oak.plugins.blob.datastore.AzureDataStore.config` PID wordt gebruikt voor configuratie.

Voor het inschakelen van de Azure-functionaliteit voor gegevensopslag moet een functiepakket met de Azure-connector worden gedownload en geïnstalleerd. Ga naar de [ Bewaarplaats van Adobe ](https://repo1.maven.org/maven2/com/adobe/granite/com.adobe.granite.oak.azureblobconnector/) en download de recentste versie van 1.6.x versies van het eigenschappak (bijvoorbeeld, com.adobe.granite.oak.azureblobconnector-1.6.3.zip).
...
* azureBlobEndpoint=&quot;&quot;: het Azure-blob-eindpunt. Bijvoorbeeld https://&lt;storage-account>.blob.core.windows.net.
* accessKey=&quot;&quot;: de naam van de opslagaccount. Voor meer details over de de authentificatiegeloofsbrieven van Microsoft® Azure, zie de [ officiële documentatie ](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-create).
...
1. Ga naar de console JMX in *https://&lt;serveraddress:port/system/console/jmx*
