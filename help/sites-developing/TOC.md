...
+ Onderdelen{#components}
   ...
   + [Ontwikkelen AEM componenten](developing-components.md)
   ...
   + [Modus voor ontwikkelaars](developer-mode.md)
...
+ Ontwikkelingsinstrumenten{#devtools}
   ...
   + [Dialoogeditor](dialog-editor.md)
   ...
   + [Gereedschap AEM](aem-repo-tool.md)
...
+ Best practices voor{#bestpractices}
   ...
   + [Inhoud architectuur](content-architecture.md)
