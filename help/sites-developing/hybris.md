...
>[!NOTE]
>
>Het eCommerce-kader kan met elke oplossing voor eCommerce worden gebruikt. Bepaalde specifieke en voorbeelden die hier worden besproken, verwijzen naar de [SAP Commerce Cloud](https://www.hybris.com/) -oplossing.
...
* De `cq:commerceProvider` eigenschap wordt ook gebruikt om naar de juiste definitie van de handelsfabriek te verwijzen.
   ...
   * Hier kunnen nog andere eigenschappen, zoals de versie [**van de **Catalogus, worden geconfigureerd](#configuringthecatalogversion)(indien van toepassing en beschikbaar).
...
* AuthenticationAEM wordt verondersteld om het *enige* Web front-end te zijn en daarom voert *al* authentificatie uit.

* Slave AccountsAEM maakt een slave-account in hybris voor elke winkelier. De gebruikersnaam van het slave-account is gelijk aan de AEM-gebruikersnaam. Een cryptografisch-willekeurig wachtwoord wordt auto-geproduceerd en (gecodeerd) opgeslagen in AEM.
