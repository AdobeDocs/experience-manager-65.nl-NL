...
>* `/libs/cq/projects`
>
>  U mag niets wijzigen in `/libs`en gebruik ze gewoon als voorbeelden. Als u een van de bestaande stappen wilt gebruiken, kopieert u deze naar `/apps` en wijzigen ze daar.
